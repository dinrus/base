...
enum : бкрат {
  ДА_ВАРИАНТ = cast(бкрат) -1, ///  Представляет булево значение _true (-1).
  НЕТ_ВАРИАНТ = cast(бкрат) 0  /// Представляет булево значение _false (0).
}
//typedef ushort БУЛ_ВАРИАНТ;
alias  ushort БУЛ_ВАРИАНТ;
...
enum /* LIBFLAGS */ : бкрат {
  БИБФЛАГ_ОГРАНИЧЕН = 0x1,
  БИБФЛАГ_КОНТРОЛ = 0x2,
  БИБФЛАГ_СКРЫТ = 0x4,
  БИБФЛАГ_ЕСТЬДИСКОБРАЗ = 0x8
}
