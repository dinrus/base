...
class ХэшФайл(К, З)
{
    ...
    **********************************************************************/
    ...
    /**********************************************************************
            ...
            Return the serialized данные for the предоставленный ключ. Возвращает
    ...
    **********************************************************************/
    ...
    private struct Запись
    {
        ...
        **************************************************************/
        ...
        проц пиши (ХэшФайл бакет, З данные, РазмерБлока блок)
        {
            ...
            if (this.использован > this.ёмкость)
                createBucket (бакет, this.использован, блок);
        ...
        **************************************************************/
        ...
        проц createBucket (ХэшФайл бакет, цел байты, РазмерБлока блок)
        {
