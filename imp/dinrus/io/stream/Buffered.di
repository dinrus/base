...
public alias БуфВывод Бвыв;  
     /// описано ранее
extern(C) БуфВвод создайБВвод(ИПотокВвода п, т_мера ёмкость = 8192);
extern(C) БуфВывод создайБВывод(ИПотокВывода п, т_мера ёмкость = 8192);
