/*******************************************************************************
        В этом модуле реализована генерная хэш-функция Merkle-Damgard.
...
/*******************************************************************************
        ...
        Расширение МерклеДамгард для создания кастомной хэш-функции требует
        реализации ряда абстрактных методов. В них входят:
        ---
