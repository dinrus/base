...
/**
 * Линкованные списки из пар (ключ, элемент).
 * author: Doug Lea
**/
deprecated public class КартаСвязка(К, T) : КоллекцияКарт!(К, T) // , ИЧитаемое, ИЗаписываемое
{
        ...
        **/
        ...
        /**
         * Создаёт пустой список с заданным скринером элемента.
        **/
        ...
        /**
         * Особая версия конструктора, требуемая для функции клонируй().
        **/
        ...
        /**
         * Создаёт независимую копию этого списка. Не клонирует элементы.
        **/
        ...
        **/
        public final T получи(К ключ)
        {
                ...
                throw new НетЭлементаИскл("Ключ не совпадает");
        }
