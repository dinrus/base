...
/*******************************************************************************
        ...
        Реализация Карты с хэш-таблицей.
...
deprecated public class ХэшКарта(К, З) : КоллекцияКарт!(К, З), ПараметрыХэш
{
        ...
        /***********************************************************************
                ...
                Таблица. Каждая запись является списком. Пусто, если таблицы в памяти не размещено.
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Сделать новую пустую карту для применения заданного скринера элементов.
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Делает независимую копию этой таблицы. Сами элементы не клонируются.
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.ПараметрыХэш.корзины.
                Временная ёмкость: O(1).
                
                См_Также: col.ПараметрыХэш.корзины.
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.ПараметрыХэш.thresholdLoadfactor
                Временная ёмкость: O(1).
                
                См_Также: col.ПараметрыХэш.thresholdLoadfactor
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.model.View.Обзор.содержит.
                Временная ёмкость: O(1) average; O(n) worst.
                
                См_Также: col.model.View.Обзор.содержит
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.model.View.Обзор.экземпляры.
                Временная ёмкость: O(n).
                
                См_Также: col.model.View.Обзор.экземпляры
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.model.View.Обзор.элементы.
                Временная ёмкость: O(1).
                
                См_Также: col.model.View.Обзор.элементы
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Возвращает элемент associated with Key ключ. 
                @param ключ a ключ
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.Map.добавь.
                Временная ёмкость: O(1) average; O(n) worst.
                
                См_Также: col.Map.добавь
        ...
        ************************************************************************/
        ...
        public final проц добавь (К ключ, З элемент)
        {
                ...
                if (hd is пусто)
                   ...
                   if (p !is пусто)
                      ...
                      таблица[h] = new ПараССТ(ключ, элемент, hd);
                      инкрСчёт();
                      проверьФакторЗагрузки(); // we only проверь фактор загрузки on добавь в_ Неукmpty bin
                      }
                   }
        }
        ...
        /***********************************************************************
                ...
                Реализует col.Map.удали.
                Временная ёмкость: O(1) average; O(n) worst.
                
                См_Также: col.Map.удали
        ...
        ************************************************************************/
        ...
        /***********************************************************************
                ...
                Реализует col.Map.replaceElement.
                Временная ёмкость: O(1) average; O(n) worst.
                
                См_Также: col.Map.replaceElement
        ...
        ************************************************************************/
        ...
        {
                ПараССТ newtab[] = new ПараССТ[новЁмк];
                ...
                if (таблица !is пусто)
                   ...
                   for (цел i = 0; i < таблица.length; ++i)
                       ...
                       while (p !is пусто)
                             {
                             ПараССТ n = cast(ПараССТ)(p.следщ());
                             цел h = (p.хэшКлюча() & 0x7FFFFFFF) % новЁмк;
                             p.следщ(newtab[h]);
                             newtab[h] = p;
                             p = n;
                             }
