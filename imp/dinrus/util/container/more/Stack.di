...
struct Стэк (V, цел Размер = 0) 
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Вернуть свободные неиспользованные ячейки
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Индексированная стековая запись, где нулевой индекс представляет
                самую свежую Запись (верх).

                Бросает исключение, когда заданный индекс вне диапазона
...
unittest
{
        ...
        проц main()
        {
                ...
                s = s.клонируй;
                Стдвыв.форматнс ("вынь одну: {}", s.вынь);
                foreach (v; s)
                         Стдвыв.форматнс ("{}", v);
                Стдвыв.форматнс ("верх: {}", s.верх);

                Стдвыв.форматнс ("вынь три");
                s.вынь;
                s.вынь;
                s.вынь;
                foreach (v; s)
