...
/** Куча - это структура данных, куда можно вставить элементы в случайном порядке
  * и вынуть в отсортированном виде. 
  * Выем элемента преобр_в the куча takes O(lg n) и popping the верх of the 
  * куча takes O(lg n). Heaps are 
...
unittest
{
        ...
        assert (h.размер is 4, "клонированная куча делит данные с исходной кучей");
        assert (h.вынь is 4, "клонированная куча делит данные с исходной кучей");
        assert (h.вынь is 3, "клонированная куча делит данные с исходной кучей");
        assert (h.вынь is 2, "клонированная куча делит данные с исходной кучей");
        assert (h.вынь is 1, "клонированная куча делит данные с исходной кучей");
}
}
