...
бул LSA_SUCCESS(цел x) { return x >= 0; }

/*	TOTHINKABOUT: These constants don't have ANSI/Unicode versioned
 *	aliases.  Should we merge them anyway?
 */
const сим[]  MICROSOFT_KERBEROS_NAME_A = "Kerberos";
const шим[] MICROSOFT_KERBEROS_NAME_W = "Kerberos";
const сим[]  MSV1_0_PACKAGE_NAME  = "MICROSOFT_AUTHENTICATION_PACKAGE_V1_0";
const шим[] MSV1_0_PACKAGE_NAMEW = "MICROSOFT_AUTHENTICATION_PACKAGE_V1_0";
...
alias бцел LSA_ENUMERATION_HANDLE, LSA_OPERATIONAL_MODE,
  POLICY_AUDIT_EVENT_OPTIONS;
alias бцел* PLSA_ENUMERATION_HANDLE, PLSA_OPERATIONAL_MODE,
