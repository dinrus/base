...
/* Comment from MinGW
	I don't know the право значения for these macros
 */
const size_t
...
struct ACMFORMATDETAILSA {
	...
	LPWAVEFORMATEX pwfx;
	DWORD          cbwfx;
	сим[ACMFORMATDETAILS_FORMAT_CHARS] szFormat;
}
...
struct ACMFORMATTAGDETAILSA {
	...
	сим[ACMFORMATTAGDETAILS_FORMATTAG_CHARS] szFormatTag;
}
...
struct ACMDRIVERDETAILSA {
	...
	DWORD  cFilterTags;
	HICON  hicon;
	сим[ACMDRIVERDETAILS_SHORTNAME_CHARS] szShortName;
	сим[ACMDRIVERDETAILS_LONGNAME_CHARS]  szLongName;
	сим[ACMDRIVERDETAILS_COPYRIGHT_CHARS] szCopyright;
	сим[ACMDRIVERDETAILS_LICENSING_CHARS] szLicensing;
	сим[ACMDRIVERDETAILS_FEATURES_CHARS]  szFeatures;
}
