...
//MACRO #define WHashValOfLHashVal(h) ((unsigned крат)(0x0000ffff&(h)))
...
extern (Windows) {
	...
	цел SysReAllocString(BSTR*, OLECHAR*);
	BSTR SysAllocStringLen(OLECHAR*, бцел);
	цел SysReAllocStringLen(BSTR*, OLECHAR*, бцел);
	проц SysFreeString(BSTR);
	бцел SysStringLen(BSTR);
	бцел SysStringByteLen(BSTR);
	BSTR SysAllocStringByteLen(сим*, бцел);
	цел DosDateTimeToVariantTime(бкрат, бкрат, дво*);
	цел VariantTimeToDosDateTime(дво, бкрат*, бкрат*);
	цел VariantTimeToSystemTime(дво, LPSYSTEMTIME);
	цел SystemTimeToVariantTime(LPSYSTEMTIME, дво*);
	...
	HRESULT SafeArrayAllocDescriptor(бцел, SAFEARRAY**);
	HRESULT SafeArrayAllocData(SAFEARRAY*);
	SAFEARRAY* SafeArrayCreate(VARTYPE, бцел, SAFEARRAYBOUND*);
	...
	бцел SafeArrayGetDim(SAFEARRAY*);
	бцел SafeArrayGetElemsize(SAFEARRAY*);
	HRESULT SafeArrayGetUBound(SAFEARRAY*, бцел, цел*);
	HRESULT SafeArrayGetLBound(SAFEARRAY*, бцел, цел*);
	HRESULT SafeArrayLock(SAFEARRAY*);
	HRESULT SafeArrayUnlock(SAFEARRAY*);
	HRESULT SafeArrayAccessData(SAFEARRAY*, проц**);
	HRESULT SafeArrayUnaccessData(SAFEARRAY*);
	HRESULT SafeArrayGetElement(SAFEARRAY*, цел*, проц*);
	HRESULT SafeArrayPutElement(SAFEARRAY*, цел*, проц*);
	HRESULT SafeArrayCopy(SAFEARRAY*, SAFEARRAY**);
	HRESULT SafeArrayPtrOfIndex(SAFEARRAY*, цел*, проц**);
	...
	проц VariantInit(VARIANTARG*);
	HRESULT VariantClear(VARIANTARG*);
	HRESULT VariantCopy(VARIANTARG*, VARIANTARG*);
	HRESULT VariantCopyInd(VARIANT*, VARIANTARG*);
	HRESULT VariantChangeType(VARIANTARG*, VARIANTARG*, бкрат, VARTYPE);
	HRESULT VariantChangeTypeEx(VARIANTARG*, VARIANTARG*, LCID, бкрат, VARTYPE);
	HRESULT VarUI1FromI2(крат, ббайт*);
	HRESULT VarUI1FromI4(цел, ббайт*);
	HRESULT VarUI1FromR4(плав, ббайт*);
	HRESULT VarUI1FromR8(дво, ббайт*);
	HRESULT VarUI1FromCy(CY, ббайт*);
	HRESULT VarUI1FromDate(DATE, ббайт*);
	HRESULT VarUI1FromStr(OLECHAR*, LCID, бцел, ббайт*);
	HRESULT VarUI1FromDisp(LPDISPATCH, LCID, ббайт*);
	HRESULT VarUI1FromBool(VARIANT_BOOL, ббайт*);
	HRESULT VarI2FromUI1(ббайт, крат*);
	HRESULT VarI2FromI4(цел, крат*);
	HRESULT VarI2FromR4(плав, крат*);
	HRESULT VarI2FromR8(дво, крат*);
	HRESULT VarI2FromCy(CY cyIn, крат*);
	HRESULT VarI2FromDate(DATE, крат*);
	HRESULT VarI2FromStr(OLECHAR*, LCID, бцел, крат*);
	HRESULT VarI2FromDisp(LPDISPATCH, LCID, крат*);
	HRESULT VarI2FromBool(VARIANT_BOOL, крат*);
	HRESULT VarI4FromUI1(ббайт, цел*);
	HRESULT VarI4FromI2(крат, цел*);
	HRESULT VarI4FromR4(плав, цел*);
	HRESULT VarI4FromR8(дво, цел*);
	HRESULT VarI4FromCy(CY, цел*);
	HRESULT VarI4FromDate(DATE, цел*);
	HRESULT VarI4FromStr(OLECHAR*, LCID, бцел, цел*);
	HRESULT VarI4FromDisp(LPDISPATCH, LCID, цел*);
	HRESULT VarI4FromBool(VARIANT_BOOL, цел*);
	HRESULT VarR4FromUI1(ббайт, плав*);
	HRESULT VarR4FromI2(крат, плав*);
	HRESULT VarR4FromI4(цел, плав*);
	HRESULT VarR4FromR8(дво, плав*);
	HRESULT VarR4FromCy(CY, плав*);
	HRESULT VarR4FromDate(DATE, плав*);
	HRESULT VarR4FromStr(OLECHAR*, LCID, бцел, плав*);
	HRESULT VarR4FromDisp(LPDISPATCH, LCID, плав*);
	HRESULT VarR4FromBool(VARIANT_BOOL, плав*);
	HRESULT VarR8FromUI1(ббайт, дво*);
	HRESULT VarR8FromI2(крат, дво*);
	HRESULT VarR8FromI4(цел, дво*);
	HRESULT VarR8FromR4(плав, дво*);
	HRESULT VarR8FromCy(CY, дво*);
	HRESULT VarR8FromDate(DATE, дво*);
	HRESULT VarR8FromStr(OLECHAR*, LCID, бцел, дво*);
	HRESULT VarR8FromDisp(LPDISPATCH, LCID, дво*);
	HRESULT VarR8FromBool(VARIANT_BOOL, дво*);
	HRESULT VarR8FromDec(DECIMAL*, дво*);
	HRESULT VarDateFromUI1(ббайт, DATE*);
	HRESULT VarDateFromI2(крат, DATE*);
	HRESULT VarDateFromI4(цел, DATE*);
	HRESULT VarDateFromR4(плав, DATE*);
	HRESULT VarDateFromR8(дво, DATE*);
	HRESULT VarDateFromCy(CY, DATE*);
	HRESULT VarDateFromStr(OLECHAR*, LCID, бцел, DATE*);
	HRESULT VarDateFromDisp(LPDISPATCH, LCID, DATE*);
	HRESULT VarDateFromBool(VARIANT_BOOL, DATE*);
	HRESULT VarCyFromUI1(ббайт, CY*);
	HRESULT VarCyFromI2(крат, CY*);
	HRESULT VarCyFromI4(цел, CY*);
	HRESULT VarCyFromR4(плав, CY*);
	HRESULT VarCyFromR8(дво, CY*);
	HRESULT VarCyFromDate(DATE, CY*);
	HRESULT VarCyFromStr(OLECHAR*, LCID, бцел, CY*);
	HRESULT VarCyFromDisp(LPDISPATCH, LCID, CY*);
	HRESULT VarCyFromBool(VARIANT_BOOL, CY*);
	HRESULT VarBstrFromUI1(ббайт, LCID, бцел, BSTR*);
	HRESULT VarBstrFromI2(крат, LCID, бцел, BSTR*);
	HRESULT VarBstrFromI4(цел, LCID, бцел, BSTR*);
	HRESULT VarBstrFromR4(плав, LCID, бцел, BSTR*);
	HRESULT VarBstrFromR8(дво, LCID, бцел, BSTR*);
	HRESULT VarBstrFromCy(CY, LCID, бцел, BSTR*);
	HRESULT VarBstrFromDate(DATE, LCID, бцел, BSTR*);
	HRESULT VarBstrFromDisp(LPDISPATCH, LCID, бцел, BSTR*);
	HRESULT VarBstrFromBool(VARIANT_BOOL, LCID, бцел, BSTR*);
	HRESULT VarBoolFromUI1(ббайт, VARIANT_BOOL*);
	HRESULT VarBoolFromI2(крат, VARIANT_BOOL*);
	HRESULT VarBoolFromI4(цел, VARIANT_BOOL*);
	HRESULT VarBoolFromR4(плав, VARIANT_BOOL*);
	HRESULT VarBoolFromR8(дво, VARIANT_BOOL*);
	HRESULT VarBoolFromDate(DATE, VARIANT_BOOL*);
	HRESULT VarBoolFromCy(CY, VARIANT_BOOL*);
	HRESULT VarBoolFromStr(OLECHAR*, LCID, бцел, VARIANT_BOOL*);
	HRESULT VarBoolFromDisp(LPDISPATCH, LCID, VARIANT_BOOL*);
	HRESULT VarDecFromR8(дво, DECIMAL*);
	ULONG LHashValOfNameSysA(SYSKIND, LCID, сим*);
	...
	HRESULT QueryPathOfRegTypeLib(REFGUID, бкрат, бкрат, LCID, LPBSTR);
	...
	HRESULT DispInvoke(проц*, LPTYPEINFO, DISPID, WORD, DISPPARAMS*, VARIANT*, EXCEPINFO*, UINT*);
	HRESULT CreateDispTypeInfo(INTERFACEDATA*, LCID, LPTYPEINFO*);
	HRESULT CreateStdDispatch(IUnknown*, проц*, LPTYPEINFO, IUnknown**);
	HRESULT RegisterActiveObject(IUnknown*, REFCLSID, DWORD, DWORD*);
	HRESULT RevokeActiveObject(DWORD, проц*);
	HRESULT GetActiveObject(REFCLSID, проц*, IUnknown**);
	HRESULT SetErrorInfo(бцел, LPERRORINFO);
	HRESULT GetErrorInfo(бцел, LPERRORINFO*);
	...
	HRESULT VarR8FromUI1(BYTE, дво*);
	HRESULT VarR8FromI2(SHORT, дво*);
	HRESULT VarR8FromI4(LONG, дво*);
	HRESULT VarR8FromI8(LONG64, дво*);
	HRESULT VarR8FromR4(FLOAT, дво*);
	HRESULT VarR8FromDate(DATE, дво*);
	HRESULT VarR8FromBool(VARIANT_BOOL, дво*);
	HRESULT VarR8FromI1(byte, дво*);
	HRESULT VarR8FromUI2(USHORT, дво*);
	HRESULT VarR8FromUI4(ULONG, дво*);
	HRESULT VarR8FromUI8(ULONG64, дво*);
	HRESULT VarR8FromStr(OLECHAR*, LCID, ULONG, дво*);
	HRESULT VarR8FromCy(CY, дво*);
	HRESULT VarR8FromDec(DECIMAL*, дво*);
	HRESULT VarR8FromDisp(IDispatch*, LCID, дво*);
	...
	HRESULT VarR4CmpR8(плав, дво);
	HRESULT VarR8Pow(дво, дво, дво*);
	HRESULT VarR8Round(дво, цел, дво*);
	...
	HRESULT VarDecRound(DECIMAL*, цел, DECIMAL*);
	...
	HRESULT VarRound(LPVARIANT, цел, LPVARIANT);
