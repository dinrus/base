...
const сим[] SQL_SPEC_STRING = "03.51";
...
static if (ODBCVER >= 0x0300) {
	...
	/* #define SQL_FUNC_EXISTS(существует, api)
	   ((*(((UWORD*) (существует)) + ((api) >> 4)) & (1 << ((api) & 15)) ) ?
	   SQL_TRUE : SQL_FALSE )
	*/
...
const сим [] SQL_ODBC_KEYWORDS =
	...
	~ "DATE, DAY, DEALLOCATE, DEC, DECIMAL, DECLARE, ДЕФОЛТ, DEFERRABLE, "
