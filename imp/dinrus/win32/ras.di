...
alias проц function (UINT, RASCONNSTATE, DWORD) RASDIALFUNC;
alias проц function(HRASCONN, UINT, RASCONNSTATE, DWORD,
DWORD) RASDIALFUNC1;
...
static if (WINVER >= 0x0500) {
	...
	проц RasFreeEapUserIdentityW (LPRASEAPUSERIDENTITYW);
	проц RasFreeEapUserIdentityA (LPRASEAPUSERIDENTITYA);
}
