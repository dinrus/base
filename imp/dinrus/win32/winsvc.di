...
extern (Windows) {
	alias проц function(DWORD, LPSTR*)  LPSERVICE_MAIN_FUNCTIONA;
	alias проц function(DWORD, LPWSTR*) LPSERVICE_MAIN_FUNCTIONW;
}
...
extern (Windows) {
	alias проц function(DWORD) LPHANDLER_FUNCTION;
