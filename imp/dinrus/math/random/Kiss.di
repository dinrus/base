...
/******************************************************************************
        ...
        ---
                ...
                z(n)=2*z(n-1)+z(n-2) +перенос mod 2^32
        ---

        The y's are a shift регистрируй sequence on 32bit binary vectors
        период 2^32-1; The z's are a simple multИПly-with-перенос sequence
...
struct Kiss
{
    ...
    **********************************************************************/
    ...
    /**********************************************************************
            ...
            Seed the generator with a предоставленный значение
    ...
    **********************************************************************/
    ...
    /**********************************************************************
            ...
            Возвращает значение in the range [0, 1) using 32 биты
    ...
    **********************************************************************/
    ...
    /**********************************************************************
            ...
            Возвращает значение in the range [0, 1) using 52 биты
            of точность (with thanks в_ Dr Jurgen A Doornik)
