...
/***********************************************************************************
 *  Резервировать указанное количество пространства в массиве
 */
...
{
    assert(индекс < стог.length, ".сотри_индекс() вызван с указанием индекса, к-ый больше длины массива");
...
/***********************************************************************************
 *  Вставить элемент x в масив по (прямо перед) индексу.
 */
проц вставь(T) (ref T[] стог, т_мера индекс, T x)
in {
  assert(индекс < стог.length+1, ".вставь()вызван с указанием индекса, к-ый больше длины массива");
}
body {
