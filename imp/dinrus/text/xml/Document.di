...
/*******************************************************************************
        ...
        узел пространство for subsequent queries. In order в_ retain результаты, do this
        ---
...
class Документ(T) : package PullParser!(T)
{
    ...
    ***********************************************************************/
    ...
    private struct NodeImpl
    {
        ...
        package ПТипУзлаРЯР     ид;             // узел тип
...
private class ПутьРЯР(T)
{
    ...
    /***********************************************************************
            ...
            can then be использован в_ cascade результаты преобр_в subsequent NodeSet
            экземпляры.
