...
/*******************************************************************************
        ...
        ---
        арги.разбор ("thisfile.txt thatfile.док -знач", да);
        ...
        ---
        арги('знач').парамы(0);
        assert (арги.разбор (`-знач thisfile.txt thatfile.док`));
        assert (арги(пусто).назначено.length is 2);
        ---
        ...
        shown. On the другой hand, an явный assignment (via '=') всегда
...
class Аргументы
{
    ...
    private const ткст[]          ошсооб =        // ошибки по умолчанию
        [
            "аргумент '{0}' ожидает {2} параметр(-ов), но имеется {1}\n",
            "аргумент '{0}' ожидает {3} параметр(-ов), но имеется {1}\n",
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            ---
            индекс 0: имя этого аргумента
            индекс 1: число параметров
            индекс 2: configured minimum параметры
            индекс 3: configured maximum параметры
            индекс 4: конфликтующий/зависимый аргумент (или непригодный параметр)
            индекс 5: массив из опций сконфигурированных параметров
            ---
    ...
    ***********************************************************************/
    ...
    private бул аргумент (ткст s, ткст p, бул полого, бул флаг)
    {
        if (s.length >= p.length && s[0..p.length] == p)
        {
            ...
            if (i < s.length)
                ...
                // trap пустой аргументы; прикрепи as парам в_ пусто-арг
                if (s.length)
    ...
    /***********************************************************************
            ...
            опции along with Несколько-флаги и smushed параметры.
    ...
    class Аргумент
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает имя of this аргумент
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Набор an exact число параметров требуется
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Добавь другой default parameter для этого аргумент
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Набор an инспектор для этого аргумент, fired when a
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Набор an вызывало для этого аргумент, fired when an
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Enable smushing для этого аргумент, where "-ofile"
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Устанавливает помощь текст для этого аргумент
...
debug(UnitTest)
{
    unittest
    {
        ...
        // Несколько флаги, with alias и полого
        ...
        // Несколько флаги with trailing арг
        assert (арги.очисть.разбор ("-xyz=10"));
        assert (z.назначено.length is 1);

        // again, but without полого парам declaration
        z.парамы(0);
        assert (!арги.очисть.разбор ("-xyz=10"));
