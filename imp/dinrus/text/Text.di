/*******************************************************************************
        Текст - это класс для управления и манипулирования массивами
        символов Unicode.

        Текст обрабатывает текущее "выделение", контролируемое через методы
         выбери() и ищи(). Каждый из добавь(), приставь(), замени() и
        удали() оперирует с соответствующим выделением.

        Методы ищи() также оперируют с соответствующим текущим
        выделением, предоставляя средства итерации по сверяемым образцам.
        Чтобы установить выделение по всему контенту, используется метод выбери()
        без аргументов.

        Индексами и длинами контента всегда подсчитываются единицы кода, а не
        точки кода. Это похоже на традиционную обработку текста аски, но
        на практике индексирование используется редко из-за идиомы выделения:
        индексирование подстрок применяется в противоположность прямому
        манипулированию. Это позволяет применять поточную модель с учётом
        суррогатов utf.

        Strings support a range of functionality, из_ вставь и removal
        в_ utf кодировка и decoding. There is also an неменяемыйподнабор
        ...
        The class is templated для использования с ткст, шим[], и дим[],
        и should мигрируй across encodings seamlessly. In particular, все
        ...
        ---
        auto исток = new Текст!(сим)("one\ntwo\nthree");

        foreach (строка; Util.строки(исток.срез))
        ...
        class Текст(T) : ТекстОбзор!(T)
        {
                ...
                Текст добавь (ИПотокВвода исток);
...
class Текст(T) : ТекстОбзор!(T)
{
    ...
    private struct Поиск(T)
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Поиск backward, starting at the character приор в_
                the выделение точка
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Поиск вперёд, starting just после the currently
                selected текст
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает да, если there is a сверь внутри the
                associated текст
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает число of совпадает внутри the associated
                текст
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                местоположение образец индекс и выбери as appropriate
    ...
    ***********************************************************************/
    ...
    {
        бцел    начало,                  /// индекс of выделение точка
    ...
    /***********************************************************************
            ...
            бцел и thus will be accepted для этого constructor, making
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Создаёт Текст upon the предоставленный контент. If saопр
            контент is неменяемый(читай-only) then you might consider
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Создаёт Текст via the контент of другой. If saопр
            контент is неменяемый(читай-only) then you might consider
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Устанавливает контент в_ the предоставленный Массив. Parameter 'копируй'
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            is неменяемый(читай-only) then you might consider настройка the
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает currently selected контент
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает индекс и length of the текущ выделение
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает текущ выделение точка
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Устанавливает текущ выделение точка, и resets выделение length
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            in a ткст. Возвращает да, если найдено, нет иначе
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Find и выбери the следщ substring occurrence.  Возвращает
            да, если найдено, нет иначе
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Find и выбери a приор substring occurrence. Возвращает
            да, если найдено, нет иначе
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Добавляет целое в_ this Текст

            deprecated: use форматируй() instead

    ***********************************************************************/

    deprecated final Текст добавь (цел знач, T[] фмт = пусто)
    {
        return добавь (cast(дол) знач, фмт);
    }
    ...
    ***********************************************************************/
    ...
    deprecated final Текст добавь (дол знач, T[] фмт = пусто)
    {
        T[64] врем =void;
        return добавь (Целое.форматируй(врем, знач, фмт));
    }
    ...
    ***********************************************************************/
    ...
    deprecated final Текст добавь (дво знач, бцел десятки=2, цел e=10)
    {
        T[64] врем =void;
        return добавь (Float.форматируй(врем, знач, десятки, e));
    }

    /***********************************************************************

            Доб контент из_ ввод поток at insertion точка. Use
            io.stream.Utf как wrapper в_ выполни conversion as
            necessary

    ***********************************************************************/

    final Текст добавь (ИПотокВвода исток)
    {
        T[8192/T.sizeof] врем =void;
        while (да)
        {
            auto длин = исток.читай (врем);
            if (длин is исток.Кф)
                break;
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Устанавливает сравнитель delegate. Where другой is пусто, we behave
            как getter only
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает length of the действителен контент
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Is this Текст equal в_ the предоставленный текст?
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Сравни this Текст старт with другой. Возвращает 0 if the
            контент совпадает, less than zero если это Текст is "less"
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Сравни this Текст старт with an Массив. Возвращает 0 if the
            контент совпадает, less than zero если это Текст is "less"
            than the другой, либо greater than zero where this Текст
            is "bigger".
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            the length of the предоставленный Массив, либо the length of the
            контент minus the снИПulated старт точка
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Strings only. Literals и другой объекты are not supported
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Сравни two массивы. Возвращает 0 if the контент совпадает, less
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            the distinction between изменяемый и неменяемыйhere.
...
class ТекстОбзор(T) : ЮниТекст
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Is this Текст equal в_ the the предоставленный текст?
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            of the предоставленный Массив, либо the length of the контент
            minus the снИПulated старт точка
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Устанавливает сравнитель delegate
...
debug (UnitTest)
{
    ...
    unittest
    {
        ...
        assert (Util.разбейнастр(s.очисть.добавь("a\nb").срез).length is 2);
