...
alias atexit_type тип_навыходе;
...
цел установи_аллегро(цел ид_системы, уцел ук_номош, тип_навыходе ук_навыходе)
{
return cast(цел) install_allegro(cast(int) ид_системы, cast(int *) ук_номош, cast(atexit_type) ук_навыходе);
}
...
цел аллегро_иниц()
{
return cast(цел) allegro_init();
}

extern (C) {
alias allegro_exit аллегро_выход;
alias check_cpu проверь_процессор;
alias allegro_message аллегро_сообщение;
alias get_executable_name дай_имя_экзе;
...
alias SYSTEM_DRIVER ДРАЙВЕР_СИСТЕМЫ;
