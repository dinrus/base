...
version(Dinrus2)
{
	...
	{
		throw new Exception("TypeInfo.equals не реализован");
	}

	export extern(D) bool _xopCmp(in ук, in ук)
	{
		throw new Exception("TypeInfo.compare не реализован");
	}

	private extern(C) void _d_setSameMutex( Object ownee,  Object owner) ;

	export extern(D) void setSameMutex( Object ownee,  Object owner)
	{
...
extern (D) class ClassInfo
{
    ...
    проц function(Object) classInvariant;
