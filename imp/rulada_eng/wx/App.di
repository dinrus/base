...
public abstract class App : EvtHandler
{
   ...
   // private Object m_caughtException=null;
    ...
    protected this() ;
    extern (C)  static bool staticInitialize(App o,inout int argc,char** argv);
    extern (C)  static bool staticOnInit(App o);
    extern (C)  static int  staticOnRun(App o);
    extern (C)  static int  staticOnExit(App o);
