...
export реал ellipticF(реал phi, реал m )
{
    реал a, b, c, e, temp, t, К;
...
export реал ellipticE(реал phi, реал m)
{
...
export реал ellipticKComplete(реал x)
in {
...
export реал ellipticEComplete(реал x)
in {
 assert(x>=0 && x<=1.0);
}
body {
 ...
 */
export реал ellipticPi(реал phi, реал m, реал n)
{
 ...
 */
export реал ellipticPiComplete(реал m, реал n)
in {
 assert(m>=-1.0 && m<=1.0);
}
body {
