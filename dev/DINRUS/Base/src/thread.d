...
module thread;
    ...
    import sync, stdrus, cidrus, exception;
...
export extern(D) class Нить
    ...
    export  static проц спи( дво период )
         ...
         *           where an exact интервал is required.
         *
         * In:
         *  период must be less than (бцел.max - 1) milliseconds.
         *
    ...
    ////////////////////////////////////////////////////////////////////////////////
    // Процедуры Поддержки СМ
    ////////////////////////////////////////////////////////////////////////////////


    /**
     * Инициализует модуль нить.Эта функция должна вызыватьсяe
     * сборщиком мусора при старте до вызова прочих поточных
     * процедур.
     */
