...
export шим[] вТкст16 (Время время)
{
    шим[32] врем =void;
...
export дим[] вТкст32 (Время время)
{
    дим[32] врем =void;
...
T[] форматируй(T) (T[] вывод, Время t)
{
    ...
    if (t is t.макс)
        throw new ИсклНелегальногоАргумента ("TimeStamp.форматируй :: аргумент Время непригоден");
...
/******************************************************************************
        ...
        Возвращает the число of элементы consumed by the разбор; zero if
        the разбор неудачно
...
/******************************************************************************
        ...
        ANSI C's анзисивремя() формат :: "Sun Nov 6 08:49:37 1994"

        Возвращает число элементов, потреблённое при разборе; ноль, если
        разбор неудачен.
