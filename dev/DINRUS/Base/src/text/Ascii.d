...
export ткст вПроп (ткст ист, ткст приёмн = пусто)
{
        if (приёмн.ptr)
           {
...
export ткст вЗаг (ткст ист, ткст приёмн = пусто)
{
        if (приёмн.ptr)
           {
           assert (приёмн.length >= ист.length);
...
export цел сравнилюб (ткст s1, ткст s2)
{
        auto длин = s1.length;
        if (s2.length < длин)
            длин = s2.length;
...
export цел сравни (ткст s1, ткст s2)
{
        auto длин = s1.length;
        if (s2.length < длин)
            длин = s2.length;
...
export static цел найдилюб (in ткст ист, in ткст образец)
{
