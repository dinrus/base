...
export class Вихрь : МерклеДамгард
{
   ...
   export this() { }
    ...
    export  override проц трансформируй(ббайт[] ввод)
    {
        ...
        /*
         * compute и apply К^0 в_ the cipher состояние:
         */
        бдол К[8] = хэш[]; 			/* the округли ключ */
        ...
        for (auto r = 1; r <= INTERNAL_ROUNDS; r++)
        {
            бдол L[8];
            /*
             * compute К^r из_ К^{r-1}:
             */
            L[0] =
                C0[cast(ббайт)(К[0] >>> 56)] ^
                C1[cast(ббайт)(К[7] >>> 48)] ^
                C2[cast(ббайт)(К[6] >>> 40)] ^
                C3[cast(ббайт)(К[5] >>> 32)] ^
                C4[cast(ббайт)(К[4] >>> 24)] ^
                C5[cast(ббайт)(К[3] >>> 16)] ^
                C6[cast(ббайт)(К[2] >>>  8)] ^
                C7[cast(ббайт)(К[1]      )] ^
                rc[r];
            L[1] =
                C0[cast(ббайт)(К[1] >>> 56)] ^
                C1[cast(ббайт)(К[0] >>> 48)] ^
                C2[cast(ббайт)(К[7] >>> 40)] ^
                C3[cast(ббайт)(К[6] >>> 32)] ^
                C4[cast(ббайт)(К[5] >>> 24)] ^
                C5[cast(ббайт)(К[4] >>> 16)] ^
                C6[cast(ббайт)(К[3] >>>  8)] ^
                C7[cast(ббайт)(К[2]      )];
            L[2] =
                C0[cast(ббайт)(К[2] >>> 56)] ^
                C1[cast(ббайт)(К[1] >>> 48)] ^
                C2[cast(ббайт)(К[0] >>> 40)] ^
                C3[cast(ббайт)(К[7] >>> 32)] ^
                C4[cast(ббайт)(К[6] >>> 24)] ^
                C5[cast(ббайт)(К[5] >>> 16)] ^
                C6[cast(ббайт)(К[4] >>>  8)] ^
                C7[cast(ббайт)(К[3]      )];
            L[3] =
                C0[cast(ббайт)(К[3] >>> 56)] ^
                C1[cast(ббайт)(К[2] >>> 48)] ^
                C2[cast(ббайт)(К[1] >>> 40)] ^
                C3[cast(ббайт)(К[0] >>> 32)] ^
                C4[cast(ббайт)(К[7] >>> 24)] ^
                C5[cast(ббайт)(К[6] >>> 16)] ^
                C6[cast(ббайт)(К[5] >>>  8)] ^
                C7[cast(ббайт)(К[4]      )];
            L[4] =
                C0[cast(ббайт)(К[4] >>> 56)] ^
                C1[cast(ббайт)(К[3] >>> 48)] ^
                C2[cast(ббайт)(К[2] >>> 40)] ^
                C3[cast(ббайт)(К[1] >>> 32)] ^
                C4[cast(ббайт)(К[0] >>> 24)] ^
                C5[cast(ббайт)(К[7] >>> 16)] ^
                C6[cast(ббайт)(К[6] >>>  8)] ^
                C7[cast(ббайт)(К[5]      )];
            L[5] =
                C0[cast(ббайт)(К[5] >>> 56)] ^
                C1[cast(ббайт)(К[4] >>> 48)] ^
                C2[cast(ббайт)(К[3] >>> 40)] ^
                C3[cast(ббайт)(К[2] >>> 32)] ^
                C4[cast(ббайт)(К[1] >>> 24)] ^
                C5[cast(ббайт)(К[0] >>> 16)] ^
                C6[cast(ббайт)(К[7] >>>  8)] ^
                C7[cast(ббайт)(К[6]      )];
            L[6] =
                C0[cast(ббайт)(К[6] >>> 56)] ^
                C1[cast(ббайт)(К[5] >>> 48)] ^
                C2[cast(ббайт)(К[4] >>> 40)] ^
                C3[cast(ббайт)(К[3] >>> 32)] ^
                C4[cast(ббайт)(К[2] >>> 24)] ^
                C5[cast(ббайт)(К[1] >>> 16)] ^
                C6[cast(ббайт)(К[0] >>>  8)] ^
                C7[cast(ббайт)(К[7]      )];
            L[7] =
                C0[cast(ббайт)(К[7] >>> 56)] ^
                C1[cast(ббайт)(К[6] >>> 48)] ^
                C2[cast(ббайт)(К[5] >>> 40)] ^
                C3[cast(ббайт)(К[4] >>> 32)] ^
                C4[cast(ббайт)(К[3] >>> 24)] ^
                C5[cast(ббайт)(К[2] >>> 16)] ^
                C6[cast(ббайт)(К[1] >>>  8)] ^
                C7[cast(ббайт)(К[0]      )];
            К[] = L[];
