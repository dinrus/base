...
export class Мд2 : МерклеДамгард
{
        private ббайт[16] C,
                          состояние;
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                be the final дайджест, либо a дайджест of the состояние between 
                calls в_ обнови()
       ...
       export  бцел размерДайджеста() { return 16; }
        ...
        ***********************************************************************/
        ...
        export override бцел добавьРазмер()
        {
                return 0;
        }
