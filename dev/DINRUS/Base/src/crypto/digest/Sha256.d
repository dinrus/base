...
export  class Sha256 : МерклеДамгард
{
        ...
        ***********************************************************************/
        ...
        export бцел размерДайджеста() { return 32; }
...
debug(UnitTest)
{
        ...
        foreach (цел i, ткст s; strings)
                ...
                assert(d == результаты[i],"Шифр:("~s~")("~d~")!=("~результаты[i]~")");
                }
        }
}
