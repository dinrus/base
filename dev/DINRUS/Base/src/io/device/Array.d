...
export class Массив : Провод, ИБуферВвода, ИБуферВывода, ИПровод.ИШаг
{
...
+/
    ...
    ***********************************************************************/
   export  this (т_мера ёмкость = 0, т_мера нарастает = 0)
    {
	    auto и = ббайтмас(ёмкость);
        присвой (и, 0);
    ...
    ***********************************************************************/
    ...
    export  this (проц[] д, т_мера читаемо)
    {
        присвой (д, читаемо);
    }
    ...
    ***********************************************************************/
    ...
    export final override ткст вТкст ()
    {
    ...
    ***********************************************************************/
    ...
    export final override т_мера читай (проц[] приёмн)
    {
   ...
   export final override т_мера пиши (проц[] ист)
    {
    ...
    ***********************************************************************/
    ...
    export final override т_мера размерБуфера ()
    {
    ...
    ***********************************************************************/
    ...
    export override дол сместись (дол смещение, Якорь якорь = Якорь.Нач)
    {
        if (смещение > предел)
            смещение = предел;
    ...
    ***********************************************************************/
    ...
    export Массив присвой (проц[] д)
    {
        return присвой (д, д.length);
    }
    ...
    ***********************************************************************/
    ...
    export Массив присвой (проц[] д, т_мера читаемо)
    {
        this.данные = д;
        this.протяженность = читаемо;
        this.дименсия = д.length;
    ...
    ***********************************************************************/
    ...
    export final проц[] срез (т_мера размер, бул съешь = да)
    {
        if (размер > читаемо)
            ошибка (недобор);
    ...
    ***********************************************************************/
    ...
    export final Массив добавь (проц[] ист)
    {
        if (пиши(ист) is Кф)
            ошибка (перебор);
        return this;
   ...
   export  final бул следщ (т_мера delegate (проц[]) скан)
    {
   ...
   export  final т_мера записываемо ()
    {
  ...
  export   final т_мера предел ()
   ...
   export  final override Массив слей ()
    {
        return this;
    }
    ...
    ***********************************************************************/
    ...
    export final т_мера писатель (т_мера delegate (проц[]) дг)
    {
   ...
   export  final т_мера читатель (т_мера delegate (проц[]) дг)
    {
    ...
    ***********************************************************************/
    ...
    export final т_мера расширь (т_мера размер)
    {
        if (расширение)
        {
