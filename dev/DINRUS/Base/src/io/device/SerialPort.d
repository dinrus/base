...
export class СерийныйПорт : Устройство
{
    ...
    ***************************************************************************/
    ...
    export СерийныйПорт скорость (бцел скорость)
    {
        version(Posix)
        {
    ...
    ***************************************************************************/
    ...
    version(Posix)
    {
        ...
        private проц создай (ткст файл)
        {
            ...
            сделайНеобр(&options); // disable echo and special characters
            tcsetattr(укз, TCSANOW, &options);
        }

        private проц сделайНеобр (termios *options)
        {
