...
export class Файл : Устройство
{
    ...
    ***********************************************************************/
    ...
    export this (ткст путь, Стиль стиль = ЧитСущ)    {
        открой (путь, стиль);
    }
    ...
    ***********************************************************************/
    ...
    export static проц[] получи (ткст путь, проц[] приёмн = пусто)
    {
    ...
    ***********************************************************************/
    ...
    export static проц установи (ткст путь, проц[] контент)
    {
    ...
    ***********************************************************************/
    ...
    export static проц добавь (ткст путь, проц[] контент)
    {
    ...
    ***********************************************************************/
    ...
    version(Win32)
    {
        ...
        protected бул открой (ткст путь, Стиль стиль, бцел добатр)
        {
            ...
            static const Флаги Созд =
                [
                    ...
                    ПРежСоздФайла.СоздатьВсегда,          // упрости всегда
        ...
        ***************************************************************/
        ...
        export проц открой (ткст путь, Стиль стиль = ЧитСущ)
        {
        ...
        ***************************************************************/
        ...
        export проц упрости (дол размер)
        {
    ...
    ***********************************************************************/
    ...
    version (Posix)
    {
        ...
        ***************************************************************/
                                       ...
                                       цел добфлаги, цел доступ = 0666)
        {
            ...
            static const Флаги Созд =
                [
                    0,                      // открой existing
                    O_CREAT | O_TRUNC,      // упрости всегда
        ...
        ***************************************************************/
        ...
        export override проц упрости (дол размер)
        {
