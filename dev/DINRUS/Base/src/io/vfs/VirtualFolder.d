...
private import text.Util : голова, местоположениеПеред;

/*******************************************************************************

        Виртуальные папки служат хостом для папок других типов, включая все
        конкретные экземпляры папок и подчинённые виртуальные папки. Можно
        построить (однокоренное) дерево из набора виртуальных и невиртуальных
        папок, и обращаться с ними как с комбинированное или единой сущностью.
        Например, создать листинг контента такого дерева ничем не отличается от
        создания листинга контента невиртуального дерева:
        потенциально в неё присутствуют лишь дополнительные узлы обхода.
...
class ВиртуальнаяПапка : ХостВфс
{
    ...
    /***********************************************************************
            ...
            У всех папок должно быть имя. Символы '.' или '/' в нём не
            допускаются.
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает (краткое) имя этой папки.
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает (длинное) имя этой папки. Виртуальные папки
            не имеют длинных имён, так как не относятся напрямую ни к
            какому конкретному экземпляру папки.
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Добавляет папку-ветвь. Эта ветвь не может 'накладываться' на другие
            папки такого же типа в дереве. Круговые ссылки обнаруживаются
            по всему дереву виртуальных папок и блокируются.

            Второй аргумент представляет дополнительное имя, о котором должен
            знать метод "прикрепи", вместо имени, предоставляемого
            данной папкой (это не alias).
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает папка представление of the given путь. If the
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает да, если все of the ветви are записываемый
