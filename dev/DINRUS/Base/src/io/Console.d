...
+/
    ...
    class Провод : Устройство
        {
            ...
            export extern(D)	бул перенаправленый(){return перенапр;}
            export extern(D)	проц перенаправленый (бул нда){  перенапр = нда;  }
            ...
            export extern(D)  override ткст вТкст() { return "<io.Console.Консоль>"; }
 ...
 version (Win32)
 {
     ...
     export extern(D)  this (т_мера укз)
                        {  	
							switch(укз)
							{								
											case 0:
     ...
     export extern(D)	final проц цвет(Цвет ц)
						{
							устЦветКонсоли( ц);
						}

     export extern(D)   ~this()	{сбросьЦветКонсоли();}
 ...
 *******************************************************/
     export extern(D) override т_мера пиши (проц[] ист)
	{
...
*******************************************************/
     ...
     version (Win32SansUnicode){} 
                                ...
                                {
         export extern(D)   override т_мера читай (проц[] приёмн)
                                {
                                if (перенапр)
