...
export class Обходчик(T) : ФильтрВвода 
{
...
export:
        ...
        {   
         debug эхо("Обходчик 1\n");		
                super (поток);
		 debug эхо("Обходчик 2\n");
                if (поток)
				{
				debug эхо("Обходчик 3\n");
                    установи (поток);
					}
        ...
        ***********************************************************************/
        ...
        {
		debug эхо("Обходчик 4\n");
                assert (поток);
			debug	 эхо("Обходчик 5\n");
                исток = создайБВвод (поток);
				super.исток = this.исток;
                assert(super.исток == this.исток, "Истоки Обходчика и БуфераВвода не совпадают!");
				debug эхо("Обходчик 7\n");
                return this;
        }
        ...
        ***********************************************************************/
        ...
        final т_мера установи (T* контент, т_мера старт, т_мера конец)
        {
        ...
        ***********************************************************************/
        ...
        final т_мера установи (T* контент, т_мера старт, т_мера конец, т_мера следщ)
        {
                срез = контент [старт .. конец];
        ...
        ***********************************************************************/
        ...
        final бул есть (T[] установи, T match)
        {
