...
export class Сокет : Провод, ИВыбираемый
{
      ...
      export   Дескр фукз ()
        ...
        ***********************************************************************/
        ...
        export Сокет подключись (ткст адрес, бцел порт)
        {
        ...
        ***********************************************************************/
        ...
        export Сокет подключись (Адрес адр)
        {
                if (планировщик)
                    асинхСвязь (адр);
                else
...
export class СерверСокет : Сокет
{      
        /***********************************************************************

        ***********************************************************************/

        export this (бцел порт, цел backlog=32, бул reuse=нет)
        {
        ...
        ***********************************************************************/
        ...
        export this (Адрес адр, цел backlog=32, бул reuse=нет)
        {
                super (адр);
        ...
        ***********************************************************************/
        ...
        export Сокет прими (Сокет реципиент = пусто)
        {
