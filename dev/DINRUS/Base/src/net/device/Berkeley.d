...
version (Windows)
        ...
        ***********************************************************************/
        ...
        export проц открой (ПСемействоАдресов семейство, ПТипСок тип, ППротокол протокол, бул создай=да)
        {
                this.тип = тип;
        ...
        /***********************************************************************
                ...
                Открыть/переоткрыть исконный сокет для этого экземпляра.

        ***********************************************************************/

        export проц переоткрой (т_сокет сок = т_сокет.init)
        {
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Возвращает underlying OS укз of this Провод
       ...
       export  цел ошибка ()
        ...
        /***********************************************************************
                ...
                Возвращает последний ошибка

        ***********************************************************************/

        export static цел последнОшиб ()
        {
                version (Win32)
        ...
        ***********************************************************************/
        ...
        export ПСемействоАдресов семействоАдресов ()
        {
                return семейство;
        }
        ...
        ***********************************************************************/
        ...
        export Беркли* подключись (Адрес куда)
        {
       ...
       export  Беркли* слушай (цел backlog)
        {
        ...
        ***********************************************************************/
        ...
        export проц прими (ref Беркли мишень)
        {
        ...
        ***********************************************************************/
        ...
        export Беркли* глуши (ПЭкстрЗакрытиеСокета как)
        {
                .экстрзак (сок, как);
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export Беркли* заминка (цел период)
        {
                version (Win32)
                         alias бкрат атр;
                   else
        ...
        ***********************************************************************/
        ...
        export Беркли* повторнИспАдреса (бул включен)
        {
                цел[1] x = включен;
        ...
        ***********************************************************************/
        ...
        export Беркли* безЗаминки (бул включен)
        {
                цел[1] x = включен;
        ...
        ***********************************************************************/
        ...
        export проц включиВГруппу (АдресИПв4 адрес, бул onOff)
        {
        ...
        ***********************************************************************/
        ...
        export Адрес новОбъектСемейства ()
        {
       ...
       export  цел шли (проц[] буф, ПФлагиСокета флаги=ПФлагиСокета.Неук)
        {       
                if (буф.length is 0)
                    return 0;
        ...
        ***********************************************************************/
        ...
        export цел отправь_на (проц[] буф, ПФлагиСокета флаги, Адрес куда)
        {
        ...
        ***********************************************************************/
        ...
        export цел отправь_на (проц[] буф, Адрес куда)
        {
        ...
        ***********************************************************************/
        ...
        export цел отправь_на (проц[] буф, ПФлагиСокета флаги=ПФлагиСокета.Неук)
        {
        ...
        ***********************************************************************/
        ...
        export цел принять (проц[] буф, ПФлагиСокета флаги=ПФлагиСокета.Неук)
        {
                if (!буф.length)
        ...
        ***********************************************************************/
        ...
        export цел принять_от (проц[] буф, ПФлагиСокета флаги, Адрес из_)
        {
                if (!буф.length)
        ...
        ***********************************************************************/
        ...
        export цел принять_от (проц[] буф, Адрес из_)
        {
        ...
        ***********************************************************************/
        ...
        export цел принять_от (проц[] буф, ПФлагиСокета флаги = ПФлагиСокета.Неук)
        {
                if (!буф.length)
                     плохойАрг ("Сокет.принять_от :: у целевого буфера нулевая длина");
        ...
        /***********************************************************************
                ...
                returns the length, в байтах, of the actual результат - very
                different из_ дайопцсок()

        ***********************************************************************/

        export цел дайОпцию (ППротокол уровень, ПОпцияСокета опция, проц[] результат)
        {
        ...
        ***********************************************************************/
        ...
        export Беркли* установиОпцию (ППротокол уровень, ПОпцияСокета опция, проц[] значение)
        {
        ...
        ***********************************************************************/
        ...
        export проц блокируется(бул да)
        {
                version (Windows)
                        {
                        бцел чис = !да;
        ...
        ***********************************************************************/
        ...
        export static проц исключение (ткст сооб)
        {
...
export class Адрес
{
        ...
        ***********************************************************************/
        ...
        export static Адрес создай (адрессок* sa) 
        { 
                switch  (sa.семейство) 
                        { 
       ...
       export static Адрес разреши (ткст хост, ткст служба = пусто, 
        ...
        ***********************************************************************/ 
        ...
        export static Адрес разреши (ткст хост, бкрат порт, 
                                ПСемействоАдресов af = ПСемействоАдресов.НЕУК, 
                                ПФлагиАИ флаги = cast(ПФлагиАИ)0) 
        { 
        ...
        ***********************************************************************/ 
        ...
        export static Адрес[] разрешиВсе (ткст хост, ткст служба = пусто, 
                                     ПСемействоАдресов af = ПСемействоАдресов.НЕУК, 
                                     ПФлагиАИ флаги = cast(ПФлагиАИ)0) 
        { 
                Адрес[] retVal; 
        ...
        ***********************************************************************/ 
        ...
        export static Адрес[] разрешиВсе (сим хост[], бкрат порт, 
                                     ПСемействоАдресов af = ПСемействоАдресов.НЕУК, 
                                     ПФлагиАИ флаги = cast(ПФлагиАИ)0) 
        { 
                сим[16] буф; 
        ...
        ***********************************************************************/ 
        ...
        export static Адрес пассивное (ткст служба, 
                                ПСемействоАдресов af = ПСемействоАдресов.НЕУК, 
                                ПФлагиАИ флаги = cast(ПФлагиАИ)0) 
        { 
        ...
        export static Адрес пассивное (бкрат порт, ПСемействоАдресов af = ПСемействоАдресов.НЕУК, 
                                ПФлагиАИ флаги = cast(ПФлагиАИ)0) 
        { 
...
export  class НеизвестныйАдрес : Адрес
{
        адрессок sa;
...
export  class АдресИПв4 : Адрес
{
        ...
        ***********************************************************************/
        ...
        export static бцел разбор(ткст адр)
        {
                сим[64] врем;
...
protected:
      ...
      export   this (адрессок* sa) 
        ...
        ***********************************************************************/ 
        ...
        export this (ткст адр, ткст служба) 
        { 
                version (Win32) 
                        { 
                        if(! getAddrinfo) 
...
export  class НетХост
{
        ...
        ***********************************************************************/
        ...
        export проц наполни (хостзап* he)
        {
                цел i;
                сим* p;
        ...
        ***********************************************************************/
        ...
        export бул дайХостПоИмени(ткст имя)
        {
                сим[1024] врем;
        ...
        ***********************************************************************/
        ...
        export бул дайХостПоАдресу(бцел адр)
        {
                бцел x = х8сбц(адр);
                synchronized (НетХост.classinfo)
                             {
        ...
        ***********************************************************************/
        ...
        //shortcut
        export бул дайХостПоАдресу(ткст адр)
        {
                сим[64] врем;
...
export  class НаборСокетов
{
        ...
        version(Windows)
        {
                ...
                export проц счёт(цел setter)
                {
                        *(cast(бцел*)буф) = setter;
                }


                export т_сокет* первый()
                {
        ...
        else version (Posix)
        {
                ...
                export бцел fdelt(т_сокет s)
                {
                        return cast(бцел)s / nfdbits;
                }


                export бцел fdmask(т_сокет s)
                {
        ...
        export НаборСокетов dup() 
        {
                return new НаборСокетов (this);
        }
        
        export НаборСокетов сбрось()
        {
                version(Win32)
                {
                        счёт = 0;
        ...
        export проц добавь(Беркли* s)
        {
                добавь(s.укз);
        }

        export проц удали(т_сокет s)
        {
                version(Win32)
                {
                        бцел c = счёт;
        ...
        export проц удали(Беркли* s)
        {
                удали(s.укз);
        }

        export цел набор_ли(т_сокет s)
        {
                version(Win32)
                {
                        т_сокет* старт = первый;
        ...
        ***********************************************************************/
        ...
        export static цел выбери (НаборСокетов проверьЧит, НаборСокетов проверьЗап, НаборСокетов проверьОш, значврем* tv)
        {
                набор_уд* fr, fw, fe;
        ...
        ***********************************************************************/
        ...
        export static цел выбери (НаборСокетов проверьЧит, НаборСокетов проверьЗап, НаборСокетов проверьОш, дол микросекунды)
        {       
                значврем tv = {
        ...
        ***********************************************************************/
        ...
        export static цел выбери (НаборСокетов проверьЧит, НаборСокетов проверьЗап, НаборСокетов проверьОш)
        {
