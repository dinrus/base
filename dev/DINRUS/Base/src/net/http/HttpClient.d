...
export class КлиентППГТ
{
	...
	struct МетодЗапроса
        ...
        ***********************************************************************/
        ...
        export this (МетодЗапроса метод, ткст url)
        {
        ...
        ***********************************************************************/
        ...
        export this (МетодЗапроса метод, Уир уир)
        {
                this.уир = уир;
                this.метод = метод;
        ...
        ***********************************************************************/
        ...
        export ОбзорЗаголовковППГТ дайЗаголовкиОтвета()
        {
                return загиНаВхо;
        }
        ...
        ***********************************************************************/
        ...
        export ЗаголовкиППГТ дайЗаголовкиЗапроса()
        {
                return загиНаВых;
        }
        ...
        ***********************************************************************/
        ...
        export ПараметрыППГТ дайПараметрыЗапроса()
        {
                return парамыВых;
        }
        ...
        /***********************************************************************
                ...
                Возвращает Уир associated with this клиент

        ***********************************************************************/

        export ОбзорУИР дайУир()
        {
                return уир;
        }
        ...
        /***********************************************************************
                ...
                Возвращает ответ-строка for the latest request. This takes
                the form of "version статус резон" as defined in the HTTP
                RFC.

        ***********************************************************************/

        export СтрокаОтвета дайОтвет()
        {
                return строкаОтвета;
        }
        ...
        /***********************************************************************
                ...
                Возвращает HTTP статус код установи by the remote сервер

        ***********************************************************************/

        export цел дайСтатус()
        {
        ...
        ***********************************************************************/
        ...
        export КлиентППГТ добавьКуки (Куки куки)
        {
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Устанавливает request метод

        ***********************************************************************/

        export КлиентППГТ установиЗапрос (МетодЗапроса метод)
        {
                this.метод = метод;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает request version

        ***********************************************************************/

        export КлиентППГТ установиВерсию (Версия знач)
        {
        ...
        ***********************************************************************/
        ...
        export КлиентППГТ активируйПеренаправление (бул данет = да)
        {
                перенаправь = данет;
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export КлиентППГТ установиТаймаут (плав интервал)
        {
                таймаут = интервал;
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export КлиентППГТ будьНаСвязи (бул данет = да)
        {
                бытьНаСвязи = данет;
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export КлиентППГТ кодируйУри (бул данет = да)
        {
                кодируй = данет;
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export БуфВывод открой (Помпа помпа)
        {
        ...
        ***********************************************************************/
        ...
        export БуфВывод открой (МетодЗапроса метод, Помпа помпа)
        {
            try {
                this.метод = метод;
                ...
                токены.очисть;
                парамыВых.произведи(cast(т_мера delegate(проц[]))(проц[] p){if (токены.читаемо) токены.пиши("&");
        ...
        ***********************************************************************/
        ...
        export проц читай (проц delegate(проц[]) сток, т_мера длин = т_мера.max)
        {
                while (да)
                      {
        ...
        ***********************************************************************/
        ...
        export БуфВывод перенаправьПост (Помпа помпа, цел статус)
        {
                switch (статус)
                       {
       ...
       export  бул можноРепостировать (бцел статус)
        {
                return нет;
        }
        ...
        /***********************************************************************
                ...
                Overrопрable сокет factory, для использования с HTTPS и so on
...
/******************************************************************************
        ...
        Класс для представления HTTP ответ-строка
