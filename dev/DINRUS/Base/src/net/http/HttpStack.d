...
export class Токен
{
    ...
    export Токен установи (ткст значение)
    {
...
export class СтэкППГТ
{
    ...
    **********************************************************************/
    ...
    export цел opApply (цел delegate(ref Токен) дг)
    {
        цел результат = 0;
    ...
    **********************************************************************/
    ...
    export final Токен найдиТокен (ткст сверь)
    {
        Токен tok;
    ...
    **********************************************************************/
    ...
    export final бул удалиТокен (ткст сверь)
    {
        for (цел i=0; i < глубина; ++i)
    ...
    **********************************************************************/
    ...
    export final Токен сунь (ткст контент)
    {
    ...
    **********************************************************************/
    ...
    export final Токен сунь (ref Токен токен)
    {
    ...
    **********************************************************************/
    ...
    export final static бул совпадает (ref Токен токен, ткст сверь)
    {
    ...
    **********************************************************************/
    ...
    export final static проц перемерь (ref Токен[] токены, цел размер)
    {
        цел i = токены.length;
