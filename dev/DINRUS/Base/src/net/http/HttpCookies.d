...
private import  io.stream.Buffered, io.model, io.stream.Iterator;
...
/*******************************************************************************
        ...
        for the RFC документ.

*******************************************************************************/

export class Куки //: ИЗаписываемое
{
        ткст          имя,
                        путь,
                        значение,
                        домен,
                        коммент;
        бцел            версия=1;              // 'version' is a reserved word
        бул            безопасно=нет;
        ...
        ***********************************************************************/
        ...
        export this (ткст имя, ткст значение)
        {
                установиИмя (имя);
        ...
        /***********************************************************************
                ...
                Устанавливает имя of this куки

        ***********************************************************************/

        export Куки установиИмя (ткст имя)
        {
                this.имя = имя;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает значение of this куки

        ***********************************************************************/

        export Куки установиЗначение (ткст значение)
        {
        ...
        /***********************************************************************
                ...
                Устанавливает version of this куки

        ***********************************************************************/

        export Куки установиВерсию (бцел версия)
        {
                this.версия = версия;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает путь of this куки

        ***********************************************************************/

        export Куки установиПуть (ткст путь)
        {
                this.путь = путь;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает домен of this куки

        ***********************************************************************/

        export Куки установиДомен (ткст домен)
        {
                this.домен = домен;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает коммент associated with this куки

        ***********************************************************************/

        export Куки установиКоммент (ткст коммент)
        {
        ...
        /***********************************************************************
                ...
                Устанавливает maximum duration of this куки

        ***********************************************************************/

        export Куки установиМаксВозраст (дол максВозраст)
        {
        ...
        ***********************************************************************/
        ...
        export Куки установиБезоп (бул безопасно)
        {
...
/+
        /***********************************************************************
                ...
                Вывод the куки как текст поток, via the предоставленный ИПисатель
...
+/
        /***********************************************************************
                ...
                Вывод the куки как текст поток, via the предоставленный consumer

        ***********************************************************************/

        export проц произведи (т_мера delegate(проц[]) используй)
        {
                используй (имя);
                ...
                if (версия)
                   ...
                   используй (";Version=");
                   используй (Целое.форматируй (врем, версия));

                   if (коммент.length)
                       используй (";Comment=\""), используй(коммент), используй("\"");

                   if (безопасно)
                       используй (";Secure");

                   if (максВозраст != максВозраст.min)
                       используй (";Max-Age="c), используй (Целое.форматируй (врем, максВозраст));
                   }
        }
...
export class СтэкКуки
{
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Возвращает свежий куки из_ the стэк

        **********************************************************************/

        export final Куки сунь ()
        {
        ...
        **********************************************************************/
        ...
        export цел opApply (цел delegate(ref Куки) дг)
        {
                цел результат = 0;
...
/*******************************************************************************
        ...
        СтэкКуки together with набор of ЗаголовкиППГТ, along with the
        appropriate куки парсер. One would do something very similar
        for клиент sопрe куки parsing also.

*******************************************************************************/

export class ОбзорКуковППГТ //: ИЗаписываемое
{
        ...
        **********************************************************************/
        ...
        export this (ОбзорЗаголовковППГТ заголовки)
        {
...
+/
        ...
        **********************************************************************/
        ...
        export проц произведи (т_мера delegate(проц[]) используй, ткст кс = КонстППГТ.Кс)
        {
                foreach (куки; разбор)
...
/*******************************************************************************
        ...
        Handles набор of вывод кукики by writing them преобр_в the список of
        вывод заголовки.

*******************************************************************************/

export class КукикиППГТ
{
        ...
        **********************************************************************/
        ...
        export this (ЗаголовкиППГТ заголовки, ИмяЗаголовкаППГТ имя = ЗаголовокППГТ.УстановитьКуки)
        {
                this.заголовки = заголовки;
                this.имя = имя;
        }
...
class РазборщикКуков : Обходчик!(сим)
{
        ...
        ***********************************************************************/
                ...
                проц установиЗначение (цел i)
                {
                        ...
                        if (имя[0] != '$')
                           ...
                           switch (вПроп (имя))
                                  ...
                                  case "$version":
                                        версия = cast(цел) Целое.разбор (токен);
                                        break;
                ...
                ***************************************************************/
                ...
                for (цел i; i < контент.length; ++i)
                    ...
                    switch (состояние)
                           ...
                           // should сейчас have either a '=', ';', либо ','
                           ...
                           // look for a quoted токен, либо a plain one
        ...
        /***********************************************************************
                ...
                буфер reference преобр_в токен. Возвращает да, если a токен was
                located, нет иначе.
