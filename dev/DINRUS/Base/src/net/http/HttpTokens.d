...
private import  time.Time, io.device.Array, io.stream.Buffered;
private import  net.http.HttpStack, net.http.HttpConst;
private import  Текст = text.Util;
private import  Целое = text.convert.Integer;
private import  ШтампВрем = text.convert.TimeStamp;
...
export class ТокеныППГТ
{
        ...
        **********************************************************************/
        ...
        export this (сим разделитель, бул включительно = нет)
        {
                стэк = new СтэкППГТ;
       ...
       export  проц разбор (ткст контент)
        {
        ...
        **********************************************************************/
        ...
        export проц установиРазобран (бул разобрано)
        {
        ...
        **********************************************************************/
        ...
        export ткст получи (ткст имя, ткст возвр = пусто)
        {
        ...
        /**********************************************************************
                ...
                предоставленный default-vaule if the заголовок does not есть_ли

        **********************************************************************/

        export цел получиЦел (ткст имя, цел возвр = -1)
        {       
        ...
        **********************************************************************/
        ...
        export Время дайДату (ткст имя, Время дата = Время.эпоха)
        {
                ткст значение = получи (имя);

                if (значение.length)
                    дата = ШтампВрем.разбор (значение);
        ...
        **********************************************************************/
        ...
        export цел opApply (цел delegate(ref ТокенППГТ) дг)
        {
                ТокенППГТ элемент;
                цел       результат = 0;
        ...
        **********************************************************************/
        ...
        export проц произведи (т_мера delegate(проц[]) используй, ткст кс = пусто)
        {
        ...
        **********************************************************************/
        ...
        final private бул разбей (Токен t, ref ТокенППГТ элемент)
        {
                ...
                if (s.length)
                   ...
                   // we should всегда найди the разделитель
                   if (i < s.length)
                      {
       ...
       export  ФильтрованныеТокены создайФильтр (ткст сверь)
        {
        ...
        **********************************************************************/
        ...
        export ткст форматируйТокены (БуфВывод приёмн, ткст разделитель)
        {
                бул первый = да;
        ...
        **********************************************************************/
        ...
        protected проц добавьДату (ткст имя, Время значение)
        {
                ...
                добавь (имя, ШтампВрем.форматируй (врем, значение));
        }
