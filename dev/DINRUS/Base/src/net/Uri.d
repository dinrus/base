...
export class Уир : ОбзорУИР
{
        ...
        ***********************************************************************/
        ...
        export this (ткст схема, ткст хост, ткст путь, ткст запрос = пусто)
        {
                this ();
        ...
        ***********************************************************************/
        ...
        export final цел дефолтнПорт (ткст схема)
        {
        ...
        ***********************************************************************/
        ...
        export final ткст инфОПользователе()
        {
                return userinfo_;
        }
        ...
        ***********************************************************************/
        ...
        export final т_мера произведи (Consumer используй)
        {
                т_мера возвр;
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                зарезервированные символы are преобразованый преобр_в their %hex version.

        ***********************************************************************/

        export static т_мера кодируй (Consumer используй, ткст s, цел флаги)
        {
                т_мера  возвр;
                сим[3] hex;
                цел     метка;
        ...
        ***********************************************************************/
        ...
        export static ткст кодируй (ткст текст, цел флаги)
        {
                проц[] s;
                ...
                if (length && memchr (s.ptr, '%', length))
                   ...
                   for (цел i; i < length; ++i, ++j, ++p)
                       ...
                       if (c is '%' && (i+2) < length)
                          ...
                          // permitting эскапирован '&' в_ remain in
                          // the запрос ткст
                          if (c && (c is ignore))
                              c = '%';
                          else
        ...
        ***********************************************************************/
        ...
        export final ткст раскодируй (ткст s)
        {
        ...
        ***********************************************************************/
        ...
        export final Уир разбор (ткст уир, бул relative = нет)
        {
                сим    c;
                цел     i, 
                        метка;
       ...
       export  final Уир отнРазбор (ткст уир)
        {
        ...
        /***********************************************************************
                ...
                Устанавливает Уир схема

        ***********************************************************************/

        export final Уир схема (ткст схема)
        {
                this.scheme_ = схема;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает Уир хост

        ***********************************************************************/

        export final Уир хост (ткст хост)
        {
                this.host_ = хост;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает Уир порт

        ***********************************************************************/

        export final Уир порт (цел порт)
        {
                this.порт_ = порт;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает Уир инфОПользователе

        ***********************************************************************/

        export final Уир инфОПользователе (ткст инфОПользователе)
        {
        ...
        /***********************************************************************
                ...
                Устанавливает Уир запрос

        ***********************************************************************/

        export final Уир запрос (ткст запрос)
        {
                this.query_ = запрос;
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export final ткст расширьЗапрос (ткст хвост)
        {
                if (хвост.length)
                    if (query_.length)
                        query_ = query_ ~ "&" ~ хвост;
        ...
        /***********************************************************************
                ...
                Устанавливает Уир путь

        ***********************************************************************/
        
        export final Уир путь (ткст путь)
        {
                this.путь_ = путь;
                return this;
        }
        ...
        /***********************************************************************
                ...
                Устанавливает Уир фрагмент

        ***********************************************************************/

        export final Уир фрагмент (ткст фрагмент)
        {
