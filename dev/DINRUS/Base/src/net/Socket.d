...
export class Сокет
{
         ...
         * omitted.
         */
        export this(ПСемействоАдресов семейство, ПТипСок тип, ППротокол протокол, бул создай=да)
        {
                this.тип = тип;
        ...
        ***********************************************************************/
        ...
        export проц переоткрой (т_сокет сок = сок.init)
        {
                инициализуй (сок);
        }
        ...
        ***********************************************************************/
        ...
        export проц блокируется(бул бда)
        {
                version(Win32)
                {
                        бцел чис = !бда;
        ...
        ***********************************************************************/
        ...
        export Сокет подключись(Адрес куда)
        {
        ...
        ***********************************************************************/
        ...
        export Сокет слушай(цел backlog)
        {
        ...
        export Сокет прими (Сокет мишень)
        {
        ...
        ***********************************************************************/
        ...
        export Сокет глуши(ПЭкстрЗакрытиеСокета как)
        {
                .глуши (сок, как);
                return this;
        }
        ...
        ***********************************************************************/
        ...
        export Сокет установиПериодЗаминки (цел период)
        {
                заминка l;
        ...
        ***********************************************************************/
        ...
        export Сокет установиПовторнИспАдреса (бул включен)
        {
                цел[1] x = включен;
        ...
        ***********************************************************************/
        ...
        export Сокет установиБезЗаминки (бул включен)
        {
                цел[1] x = включен;
        ...
        ***********************************************************************/
        ...
        export Сокет установиОпцию (ППротокол уровень, ПОпцияСокета опция, проц[] значение)
        {
        ...
        ***********************************************************************/
        ...
        export static цел выбери (НаборСокетов проверьЧит, НаборСокетов проверьЗап, НаборСокетов проверьОш, ИнтервалВремени время)
        {
        ...
        ***********************************************************************/
        ...
        export static значврем вЗначВрем (ИнтервалВремени время)
        {
                значврем tv;
...
export class АдресИПв4 : Адрес
{
        ...
        ***********************************************************************/
        ...
        export synchronized ткст вТкстАдреса()
        {
		адрес_ин адр;
		адр.с_адр = син.адрИС;
