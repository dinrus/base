...
private import  thread, io.model;
...
export class СокетСлушатель
{
        ...
        **********************************************************************/
        ...
        export this (ИПотокВвода поток, ИБуфер буфер)
        {
                assert (поток);
                this.буфер = буфер;
        ...
        **********************************************************************/
        ...
        export проц устЛимитОшибок (бкрат предел)
        {
