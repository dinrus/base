...
alias HANDLE HINST, HGLOBAL, HLOCAL, HWND, HINSTANCE, HGDIOBJ, HACCEL, HBITMA, HBRUSH, HCOLORSPACE, HDC, HGLRC, HDESK, HENHMETAFILE, HFONT, HICON, HMENU, HMETAFILE, HPALETTE, HPEN, HRGN, HRSRC, HMONITOR, HSTR, HTASK, HWINSTA, HKEY, HKL, HBITMAP, HTHEME;
...
alias HFONT УШрифт;
alias HWND УОК;
alias ук УСписокКартинок, УБитмап;
alias ук SC_HANDLE;
...
alias проц  function( ткст файл, т_мера строка, ткст сооб = пусто ) TипПроверОбр;
alias ИнфоОтслежИскл function( ук укз = пусто ) TипСледОбр;	
...
//exception
	...
	//бул устСледОбр( TипСледОбр h );
	//бул устПроверОбр( TипПроверОбр h );	
