...
version (Windows)
        ...
        */
        ...
        проц переоткрой (т_сокет сок = т_сокет.init);
        проц открепи ();
        т_сокет укз ();
        цел ошибка ();
...
extern(D) class АдресИПв4 : Адрес
{
...
extern(D) class АдресИПв6 : Адрес 
{ 
...
/*******************************************************************************
        ...
        набор of СОКЕТs for Беркли.выбери()
