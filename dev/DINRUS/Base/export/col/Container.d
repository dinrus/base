...
struct Контейнер
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            default загрузи фактор for a non-пустой hashmap. The хэш
    ...
    ***********************************************************************/
    ...
    static т_мера хэш(К) (К ключ, т_мера length)
    {
        static if (is(К : цел)   || is(К : бцел)   ||
            ...
            return cast(т_мера) (ключ % length);
        else
            return (typeid(К).дайХэш(&ключ) & 0x7FFFFFFF) % length;
    }
    ...
    /***********************************************************************
            ...
            аллокатором (примерно в 50x быстрее с СвязныйСписок)
    ...
    struct ЧанкСМ(T)
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Should return да if supported, or нет иначе.
