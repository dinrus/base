...
public interface Сек(T) : ОбзорСека!(T), Расходчик!(T)
{
     ...
     * </PRE>
     * Выводит исключение: IllegalElementException, если !можетВключить какой-то элемент из e;
    ...
    **/
     ...
     * </PRE>
     * Выводит исключение: НетЭлементаИскл, если индекс не в диапазоне 0..размер()
     * Выводит исключение: IllegalElementException, если !можетВключить(элемент)
    **/
     ...
     * Выводит исключение: IllegalElementException if !можетВключить(элемент)
    **/
