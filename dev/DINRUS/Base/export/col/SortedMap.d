        ...
        : ИКонтейнер!(З)
{
    ...
    // корень of the дерево. Пусто, если он пустой.
    package Реф                     дерево;
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Особая версия конструктора needed by dup()
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает значение associated with Key ключ.

            Параметр: ключ a ключ
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает значение of the ключ exactly совпадают the предоставленный
            ключ or, if Неук, the ключ just после/перед it based on the
            настройка of the секунда аргумент

            Параметр: ключ a ключ
            Параметр: после indicates whether в_ look beyond or перед
                   the given ключ, where there is no exact сверь
            throws: НетЭлементаИскл if Неук найдено
            returns: a pointer в_ the значение, либо пусто if not present
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает первый ключ of the карта
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает последний ключ of the карта
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Параметр: ключ a ключ
            Возвращает: a pointer в_ the значение, либо пусто if not present
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает да, если inserted, нет where an existing ключ
