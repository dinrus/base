...
public class КЧПара(К, T) : КЧЯчейка!(T) 
{
        ...
        /**
         * Создаёт ячейка with given ключ и элемент значения, и пусто линки
        **/
        ...
        /**
         * Создаёт new узел with same ключ и элемент значения, but пусто линки
        **/
        ...
        **/
        ...
        /**
         * найди и return a ячейка holding ключ, либо пусто if no such
        **/
