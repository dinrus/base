    ...
    **********************************************************************/
    ...
    /**********************************************************************
            ...
            items of the form: $(BR)$(BR)
              ...
              $(LI alignment $(BR)
                An optional целое indicating the minimum ширина. The
    ...
    **********************************************************************/
    ...
    private бцел разбор (T[] выкладка, ИнфОТипе[] иот, Арг[] арги, Сток сток)
    {
        ...
        while (да)
        {
            ...
            // имеется minimum or maximum ширина?
            if (*s is ',' || *s is '.')
            {
                if (*s is '.')
                    crop = да;
            ...
            проц process (ИнфОТипе _ti, Арг _arg)
            {
                ...
                else if (_ti.classinfo.имя[9] is КодТипа.ARRAY)
                {
...
debug (UnitTest)
{
    unittest
    {
        ...
        // ширина specifier indicates число of decimal places
