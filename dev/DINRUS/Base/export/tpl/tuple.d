...
/**
 * Возвращает the индекс of the first occurrence of T in СписокТ or Tlist.length if
 * не найден.
 */
...
/**
 * Возвращает Кортеж with the first occurrence of T removed из_ СписокТ.
 */
...
/**
 * Возвращает Кортеж with все occurrences of T removed из_ СписокТ.
 */
...
/**
 * Возвращает Кортеж with the first offuccrence of T replaced with U.
 */
...
/**
 * Возвращает Кортеж with все occurrences of T replaced with U.
 */
...
/**
 * Возвращает Кортеж with the типы из_ СписокТ declared in реверс order.
 */
...
/**
 * Возвращает Кортеж with все duplicate типы removed.
 */
...
/**
 * Возвращает the тип из_ СписокТ that is the most производный из_ T.  If no such
...
/**
 * Возвращает Кортеж with the типы sorted so that the most производный типы are
