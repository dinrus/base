...
enum ПОсобаяПапка {
  ...
  Принтеры = 0x0004,                ///
  Персональная = 0x0005,                /// The directory that serves как common repository for documents.
  Избранное = 0x0006,               /// The directory that serves как common repository for the user's favorite items.
  ...
  Документы = Персональная,             /// The directory that serves как common repository for documents.
  Музыка = 0x000d,                   /// The "_Music" folder.
  Видео = 0x000e,                   /// The "_Video" folder.
  ПапкаРабСтола = 0x0010,        /// The directory used to physically store file объекты on the desktop.
  Компьютер = 0x0011,                /// The "_Computer" folder.
  Сеть = 0x0012,                 /// The "_Network" folder.
  Шрифты = 0x0014,                   /// The directory that serves как common repository for fonts.
  Шаблоны = 0x0015,               /// The directory that serves как common repository for документ templates.
  ОбщСтартМеню = 0x0016,         /// 
  ОбщПрограммы = 0x0017,          /// The directory for components that are shared across applications.
  ОбщСтартап = 0x0018,           /// 
  ОбщПапкаРабСтола = 0x0019,  /// 
  ДанныеПриложений = 0x001a,         /// The directory that serves как common repository for application-specific data for the current roaming user.
  ЛокДанныеПриложений = 0x001c,    /// The directory that serves как common repository for application-specific data that is used by the current, non-roaming user.
  ИнтернетКэш = 0x0020,           /// The directory that serves как common repository for temporary Internet files.
  Куки = 0x0021,                 /// The directory that serves как common repository for Internet cookies.
  История = 0x0022,                 /// The directory that serves как common repository for Internet history items.
  ОбщДанныеПриложений = 0x0023,   /// The directory that serves как common repository for application-specific data that is used by all users.
