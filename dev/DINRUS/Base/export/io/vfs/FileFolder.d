...
/*******************************************************************************
        ...
        Представляет физическую папку на файловой системе. Используется для
        адресации к определённому пути (поддеревьям) внутри файловой системы.
...
class ФайлПапка : ПапкаВфс
{
        ...
        /***********************************************************************
                ...
                Создаёт папку файлов по заданному пути. 

                Опция 'создай' создаст путь, если установлено да, 
                или - в противном случае - ссылку на существующий путь.
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Создать ФайлПапку как член группы.
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Явно создай() или открой() именованную папку.
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Какая-либо папка добавляется или удаляется из иерархии. 
                Этот метод используется для проверки валидности (или иного)
				и вывода - при необходимости - исключения.

                Здесь проверяется факт накладки.
...
/*******************************************************************************
        ...
        Представляет группа of файлы (need this declared here в_ avoопр
