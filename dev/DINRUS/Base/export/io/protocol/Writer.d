...
class Писатель : ИПисатель
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Дамп контента массива в буфер. По умолчанию
            префиксируется число байтов в массиве.

    ***********************************************************************/

   проц пишиМассив (ук ист, бцел байты, ИПротокол.Тип тип);

    /***********************************************************************

            Дамп контента массива в буфер.

    ***********************************************************************/

   проц пишиЭлемент (ук ист, бцел байты, ИПротокол.Тип тип);
