...
{
    /**
     * Concatenate two списки together.  The резing list type is of the type
     * of the лево hand side.
     */
    Список!(V) opCat(Список!(V) rhs);

    /**
     * Concatenate this list и an массив together.
     *
    ...
    /**
     * Concatenate an массив и this list together.
     *
     * The резing list is the same type as this list.
     */
