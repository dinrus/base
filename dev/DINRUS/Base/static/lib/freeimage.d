...
const uint  BMP_DEFAULT         = 0,
            ...
            FAXG3_DEFAULT		= 0,
            GIF_DEFAULT			= 0,
            GIF_LOAD256			= 1,	// Load the image как 256 цвет image with ununsed palette entries, if it's 16 or 2 цвет
            ...
            JPEG_PROGRESSIVE	= 0x2000,	// save как progressive-JPEG (use | to combine with other save flags)
            KOALA_DEFAULT       = 0,
            LBM_DEFAULT         = 0,
            MNG_DEFAULT         = 0,
            PCD_DEFAULT         = 0,
            ...
            PNM_DEFAULT         = 0,
            PNM_SAVE_RAW        = 0,       // If set the writer saves in RAW format (т.е. P4, P5 or P6)
            PNM_SAVE_ASCII      = 1,       // If set the writer saves in ASCII format (т.е. P1, P2 or P3)
            PSD_DEFAULT         = 0,
            RAS_DEFAULT         = 0,
            SGI_DEFAULT			= 0,
            TARGA_DEFAULT       = 0,
