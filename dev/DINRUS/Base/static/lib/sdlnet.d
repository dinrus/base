...
void SDL_NET_VERSION(ВерсияСДЛ* X)
{
    X.майор = SDL_NET_MAJOR_VERSION;
    X.минор = SDL_NET_MINOR_VERSION;
    X.патч = SDL_NET_PATCHLEVEL;
}
...
extern(C)
{
    ВерсияСДЛ* function() SDLNet_Linked_Version;
