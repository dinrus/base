...
void SDL_MIXER_VERSION(ВерсияСДЛ* X)
{
    X.майор = SDL_MIXER_MAJOR_VERSION;
    X.минор = SDL_MIXER_MINOR_VERSION;
    X.патч = SDL_MIXER_PATCHLEVEL;
}
...
extern (C)
{
    ВерсияСДЛ* function() Mix_Linked_Version;
    ...
    Mix_Chunk* function(ЧЗоперации*, int) Mix_LoadWAV_RW;
    Mix_Music* function(char*) Mix_LoadMUS;
    Mix_Music* function(ЧЗоперации*) Mix_LoadMUS_RW;
