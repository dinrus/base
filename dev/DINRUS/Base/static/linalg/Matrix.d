...
debug (MatrixMain) {
    ...
    void проверь_mat(ref Mat33 A, num_t[9] v) {
        assert(A.m00 == v[0]);
        assert(A.m01 == v[1]);
        assert(A.m02 == v[2]);
        assert(A.m10 == v[3]);
    ...
    void проверь_matf(ref Mat33 A, num_t[9] v) {
    ...
    void проверь_mat(ref Mat22 A, num_t[4] v) {
        assert(A.m00 == v[0]);
        assert(A.m01 == v[1]);
        assert(A.m10 == v[2]);
        assert(A.m11 == v[3]);
    }
    void проверь_mat(ref Mat23 A, num_t[6] v) {
        assert(A.m00 == v[0]);
        assert(A.m01 == v[1]);
        assert(A.m02 == v[2]);
        assert(A.m10 == v[3]);
    ...
    void проверь_mat(ref Mat32 A, num_t[6] v) {
        assert(A.m00 == v[0]);
        assert(A.m01 == v[1]);
        assert(A.m10 == v[2]);
        assert(A.m11 == v[3]);
    ...
    void проверь_vec(ref Vec2 x, num_t[2] v) {
        assert(x[0] == v[0]);
        assert(x[1] == v[1]);
    }
    void проверь_vec(ref Vec3 x, num_t[3] v) {
        assert(x[0] == v[0]);
        assert(x[1] == v[1]);
        assert(x[2] == v[2]);
    }
