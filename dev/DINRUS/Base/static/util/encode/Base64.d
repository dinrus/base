...
export цел кодируйЧанк(ббайт[] данные, ткст buff, ref цел байтЗакодировано)
{
...
body
{
    ...
    if (данные.length > 0)
    {
        ...
        цел члоБайтов = кодируйЧанк(данные, buff, байтЗакодировано);
        сим *rtnPtr = buff.ptr + байтЗакодировано;
