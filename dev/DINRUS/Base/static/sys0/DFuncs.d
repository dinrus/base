...
бул ДублируйДескр(ук исходнПроц, ук исходнНить, ук хендлПроцЦели, ук *цхендл, бцел доступ, бул наследоватьДескр, бцел опции)
	{
...
{return cast(бул) ReadConsoleOutputA(cast(HANDLE)  hConsoleOutput, cast(PCHAR_INFO)  lpBuffer, cast(COORD)  dwBufferSize, cast(COORD)  dwBufferCoord, cast(PSMALL_RECT)  lpReadRegion);}
{return cast(бул) ReadConsoleOutputW(cast(HANDLE)  hConsoleOutput, cast(PCHAR_INFO)  lpBuffer, cast(COORD)  dwBufferSize, cast(COORD)  dwBufferCoord, cast(PSMALL_RECT)  lpReadRegion);}

{return cast(бул) WriteConsoleOutputAcast(HANDLE)  hConsoleOutput, in cast(PCHAR_INFO) lpBuffer, cast(COORD)  dwBufferSize, cast(COORD)  dwBufferCoord, cast(PSMALL_RECT)  lpWriteRegion);}
{return cast(бул) WriteConsoleOutputWcast(HANDLE)  hConsoleOutput, in cast(PCHAR_INFO) lpBuffer, cast(COORD)  dwBufferSize, cast(COORD)  dwBufferCoord, cast(PSMALL_RECT)  lpWriteRegion);}
{return cast(бул) ReadConsoleOutputCharacterA(cast(HANDLE)  hConsoleOutput, cast(LPSTR)  lpCharacter, cast(DWORD) nLength, cast(COORD)  dwReadCoord, cast(LPDWORD) lpNumberOfCharsRead);}
{return cast(бул) ReadConsoleOutputCharacterW(cast(HANDLE)  hConsoleOutput,cast( LPWSTR)  lpCharacter, cast(DWORD) nLength, cast(COORD)  dwReadCoord, cast(LPDWORD) lpNumberOfCharsRead);}
{return cast(бул) ReadConsoleOutputAttributecast(HANDLE)  hConsoleOutput, cast( LPWORD)  lpAttribute, cast(DWORD) nLength, cast(COORD)  dwReadCoord, cast(LPDWORD) lpNumberOfAttrsRead);}
{return cast(бул) WriteConsoleOutputCharacterAcast(HANDLE)  hConsoleOutput, cast( LPCSTR)  lpCharacter, cast(DWORD) nLength, cast(COORD)  dwWriteCoord, cast(LPDWORD) lpNumberOfCharsWritten);}
{return cast(бул) WriteConsoleOutputCharacterWcast(HANDLE)  hConsoleOutput, LPCWSTR lpCharacter, cast(DWORD) nLength, cast(COORD)  dwWriteCoord, cast(LPDWORD) lpNumberOfCharsWritten);}
{return cast(бул) WriteConsoleOutputAttributecast(HANDLE)  hConsoleOutput, in WORD *lpAttribute, cast(DWORD) nLength, cast(COORD)  dwWriteCoord, cast(LPDWORD) lpNumberOfAttrsWritten);}
{return cast(бул) FillConsoleOutputCharacterAcast(HANDLE)  hConsoleOutput, CHAR cCharacter, cast(DWORD)  nLength, cast(COORD)   dwWriteCoord, cast(LPDWORD) lpNumberOfCharsWritten);}
{return cast(бул) FillConsoleOutputCharacterWcast(HANDLE)  hConsoleOutput, WCHAR cCharacter, cast(DWORD)  nLength, cast(COORD)   dwWriteCoord, cast(LPDWORD) lpNumberOfCharsWritten);}
{return cast(бул) FillConsoleOutputAttributecast(HANDLE)  hConsoleOutput, WORD   wAttribute, cast(DWORD)  nLength, cast(COORD)   dwWriteCoord, cast(LPDWORD) lpNumberOfAttrsWritten);}
...
{return cast(бул) GetConsoleScreenBufferInfocast(HANDLE)  hConsoleOutput, cast( PCONSOLE_SCREEN_BUFFER_INFO)  lpConsoleScreenBufferInfo);}
cast(COORD)  GetLargestConsoleWindowSize( HANDLE hConsoleOutput);}
{return cast(бул) GetConsoleCursorInfocast(HANDLE)  hConsoleOutput, cast( PCONSOLE_CURSOR_INFO)  lpConsoleCursorInfo);}
{return cast(бул) GetNumberOfConsoleMouseButtons( cast(LPDWORD) lpNumberOfMouseButtons);}


{return cast(бул) SetConsoleTextAttribute(cast(HANDLE)  hConsoleOutput, WORD wAttributes);}
...
{return cast(бул) ReadConsoleA(cast(HANDLE)  hConsoleInput, cast(LPVOID)  lpBuffer, cast(DWORD) nNumberOfCharsToRead, cast(LPDWORD) lpNumberOfCharsRead, cast(LPVOID)  lpReserved);}
{return cast(бул) ReadConsoleW(cast(HANDLE)  hConsoleInput, cast(LPVOID)  lpBuffer, cast(DWORD) nNumberOfCharsToRead, cast(LPDWORD) lpNumberOfCharsRead, cast(LPVOID)  lpReserved);}
{return cast(бул) WriteConsoleA(cast(HANDLE)  hConsoleOutput, in  void *lpBuffer, cast(DWORD) nNumberOfCharsToWrite, cast(LPDWORD) lpNumberOfCharsWritten, cast(LPVOID)  lpReserved);}
{return cast(бул) WriteConsoleW(cast(HANDLE)  hConsoleOutput, in  void *lpBuffer, cast(DWORD) nNumberOfCharsToWrite, cast(LPDWORD) lpNumberOfCharsWritten, cast(LPVOID)  lpReserved);}
...
cast(BOOL) GetBinaryTypeA(cast(LPCSTR), LPcast(DWORD));}
...
cast(BOOL) GetDiskFreeSpaceA(cast(LPCSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
...
cast(DWORD) GetCompressedFileSizeA(cast(LPCSTR), LPcast(DWORD));}
...
cast(BOOL) GetNamedPipeHandleStateA(cast(HANDLE), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), cast(LPSTR), cast(DWORD));}
...
cast(BOOL) GetVolumeInformationA(cast(LPCSTR), cast(LPSTR), cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), cast(LPSTR), cast(DWORD));}
...
cast(BOOL) ReadEventLogA(cast(HANDLE), cast(DWORD), cast(DWORD), cast(LPVOID), cast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) ReportEventA(cast(HANDLE), бкрат, бкрат, cast(DWORD), PSID, бкрат, cast(DWORD), cast(LPCSTR)*, cast(LPVOID));}
cast(BOOL) AccessCheckAndAuditAlarmA(cast(LPCSTR), cast(LPVOID), cast(LPSTR), cast(LPSTR), PSECURITY_DESCRIPTOR, cast(DWORD), PGENERIC_MAPPING, cast(BOOL), LPcast(DWORD), LPcast(BOOL), LPcast(BOOL));}
...
cast(BOOL) GetFileSecurityA(cast(LPCSTR), SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, cast(DWORD), LPcast(DWORD));}
cast(HANDLE) FindFirstChangeNotificationA(cast(LPCSTR), cast(BOOL), cast(DWORD));}
cast(BOOL) LookupAccountSidA(cast(LPCSTR), PSID, cast(LPSTR), LPcast(DWORD), cast(LPSTR), LPcast(DWORD), PSID_NAME_USE);}
cast(BOOL) LookupAccountNameA(cast(LPCSTR), cast(LPCSTR), PSID, LPcast(DWORD), cast(LPSTR), LPcast(DWORD), PSID_NAME_USE);}
cast(BOOL) LookupPrivilegeValueA(cast(LPCSTR), cast(LPCSTR), PLUID);}
cast(BOOL) LookupPrivilegeNameA(cast(LPCSTR), PLUID, cast(LPSTR), LPcast(DWORD));}
cast(BOOL) LookupPrivilegeDisplayNameA(cast(LPCSTR), cast(LPCSTR), cast(LPSTR), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) GetDefaultCommConfigA(cast(LPCSTR), LPCOMMCONFIG, LPcast(DWORD));}
cast(BOOL) SetDefaultCommConfigA(cast(LPCSTR), LPCOMMCONFIG, cast(DWORD));}
cast(BOOL) GetComputerNameA(cast(LPSTR), LPcast(DWORD));}
cast(BOOL) SetComputerNameA(cast(LPCSTR));}
cast(BOOL) GetUserNameA(cast(LPSTR), LPcast(DWORD));}
...
cast(BOOL) GetUserObjectInformationA(cast(HANDLE), цел, PVOID, cast(DWORD), LPcast(DWORD));}
...
LRESULT SendMessageTimeoutA(HWND, UINT, WPARAM, LPARAM, UINT, UINT, LPcast(DWORD));}
...
cast(DWORD) GetFileVersionInfoSizeA(cast(LPSTR), LPcast(DWORD));}
...
LONG RegCreateKeyExA(HKEY, cast(LPCSTR), cast(DWORD), cast(LPSTR), cast(DWORD), REGSAM, cast(LPSECURITY_ATTRIBUTES), PHKEY, LPcast(DWORD));}
...
LONG RegEnumKeyExA(HKEY, cast(DWORD), cast(LPSTR), LPcast(DWORD), LPcast(DWORD), cast(LPSTR), LPcast(DWORD), PFILETIME);}
LONG RegEnumValueA(HKEY, cast(DWORD), cast(LPSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPBYTE, LPcast(DWORD));}
...
LONG RegQueryInfoKeyA(HKEY, cast(LPSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), PFILETIME);}
LONG RegQueryValueA(HKEY, cast(LPCSTR), cast(LPSTR), PLONG);}
LONG RegQueryMultipleValuesA(HKEY, PVALENT, cast(DWORD), cast(LPSTR), LPcast(DWORD));}
LONG RegQueryValueExA(HKEY, cast(LPCSTR), LPcast(DWORD), LPcast(DWORD), LPBYTE, LPcast(DWORD));}
...
cast(BOOL) PeekConsoleInputA(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
cast(BOOL) ReadConsoleInputA(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
cast(BOOL) WriteConsoleInputA(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
...
cast(BOOL) ReadConsoleOutputCharacterA(cast(HANDLE), cast(LPSTR), cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) WriteConsoleOutputCharacterA(cast(HANDLE), cast(LPCSTR), cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) FillConsoleOutputCharacterA(cast(HANDLE), сим, cast(DWORD), COORD, LPcast(DWORD));}
...
cast(BOOL) ReadConsoleA(cast(HANDLE), cast(LPVOID), cast(DWORD), LPcast(DWORD), cast(LPVOID));}
cast(BOOL) WriteConsoleA(cast(HANDLE), LPVOID, cast(DWORD), LPcast(DWORD), cast(LPVOID));}
...
cast(DWORD) WNetGetConnectionA(cast(LPCSTR), cast(LPSTR), LPcast(DWORD));}
cast(DWORD) WNetUseConnectionA(HWND, LPNETRESOURCE, cast(LPCSTR), cast(LPCSTR), cast(DWORD), cast(LPSTR), LPcast(DWORD), LPcast(DWORD));}
...
cast(DWORD) WNetEnumResourceA(cast(HANDLE), LPcast(DWORD), cast(LPVOID), LPcast(DWORD));}
cast(DWORD) WNetGetUniversalNameA(cast(LPCSTR), cast(DWORD), cast(LPVOID), LPcast(DWORD));}
cast(DWORD) WNetGetUserA(cast(LPCSTR), cast(LPSTR), LPcast(DWORD));}
cast(DWORD) WNetGetProviderNameA(cast(DWORD), cast(LPSTR), LPcast(DWORD));}
cast(DWORD) WNetGetNetworkInformationA(cast(LPCSTR), LPNETINFOSTRUCT);}
cast(DWORD) WNetGetLastErrorA(LPcast(DWORD), cast(LPSTR), cast(DWORD), cast(LPSTR), cast(DWORD));}
cast(DWORD) MultinetGetConnectionPerformanceA(LPNETRESOURCE, LPNETCONNECTINFOSTRUCT);}
cast(BOOL) ChangeServiceConfigA(SC_cast(HANDLE), cast(DWORD), cast(DWORD), cast(DWORD), cast(LPCSTR), cast(LPCSTR), LPcast(DWORD), cast(LPCSTR), cast(LPCSTR), cast(LPCSTR), cast(LPCSTR));}
SC_cast(HANDLE) CreateServiceA(SC_cast(HANDLE), cast(LPCSTR), cast(LPCSTR), cast(DWORD), cast(DWORD), cast(DWORD), cast(DWORD), cast(LPCSTR), cast(LPCSTR), LPcast(DWORD), cast(LPCSTR), cast(LPCSTR), cast(LPCSTR));}
cast(BOOL) EnumDependentServicesA(SC_cast(HANDLE), cast(DWORD), LPENUM_SERVICE_STATUS, cast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) EnumServicesStatusA(SC_cast(HANDLE), cast(DWORD), cast(DWORD), LPENUM_SERVICE_STATUS, cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) GetServiceKeyNameA(SC_cast(HANDLE), cast(LPCSTR), cast(LPSTR), LPcast(DWORD));}
cast(BOOL) GetServiceDisplayNameA(SC_cast(HANDLE), cast(LPCSTR), cast(LPSTR), LPcast(DWORD));}
...
cast(BOOL) QueryServiceConfigA(SC_cast(HANDLE), LPQUERY_SERVICE_CONFIG, cast(DWORD), LPcast(DWORD));}
cast(BOOL) QueryServiceLockStatusA(SC_cast(HANDLE), LPQUERY_SERVICE_LOCK_STATUS, cast(DWORD), LPcast(DWORD));}
...
UINT DdeInitializeA(LPcast(DWORD), PFNCALLBACK, cast(DWORD), cast(DWORD));}
...
cast(BOOL) GetBinaryTypeW(cast(LPCWSTR), LPcast(DWORD));}
...
cast(BOOL) GetDiskFreeSpaceW(cast(LPCWSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
...
cast(DWORD) GetCompressedFileSizeW(cast(LPCWSTR), LPcast(DWORD));}
...
cast(BOOL) GetNamedPipeHandleStateW(cast(HANDLE), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), cast(LPWSTR), cast(DWORD));}
...
cast(BOOL) GetVolumeInformationW(cast(LPCWSTR), cast(LPWSTR), cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), cast(LPWSTR), cast(DWORD));}
...
cast(BOOL) ReadEventLogW(cast(HANDLE), cast(DWORD), cast(DWORD), cast(LPVOID), cast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) ReportEventW(cast(HANDLE), бкрат, бкрат, cast(DWORD), PSID, бкрат, cast(DWORD), cast(LPCWSTR)*, cast(LPVOID));}
cast(BOOL) AccessCheckAndAuditAlarmW(cast(LPCWSTR), cast(LPVOID), cast(LPWSTR), cast(LPWSTR), PSECURITY_DESCRIPTOR, cast(DWORD), PGENERIC_MAPPING, cast(BOOL), LPcast(DWORD), LPcast(BOOL), LPcast(BOOL));}
...
cast(BOOL) GetFileSecurityW(cast(LPCWSTR), SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, cast(DWORD), LPcast(DWORD));}
cast(HANDLE) FindFirstChangeNotificationW(cast(LPCWSTR), cast(BOOL), cast(DWORD));}
cast(BOOL) LookupAccountSidW(cast(LPCWSTR), PSID, cast(LPWSTR), LPcast(DWORD), cast(LPWSTR), LPcast(DWORD), PSID_NAME_USE);}
cast(BOOL) LookupAccountNameW(cast(LPCWSTR), cast(LPCWSTR), PSID, LPcast(DWORD), cast(LPWSTR), LPcast(DWORD), PSID_NAME_USE);}
cast(BOOL) LookupPrivilegeValueW(cast(LPCWSTR), cast(LPCWSTR), PLUID);}
cast(BOOL) LookupPrivilegeNameW(cast(LPCWSTR), PLUID, cast(LPWSTR), LPcast(DWORD));}
cast(BOOL) LookupPrivilegeDisplayNameW(cast(LPCWSTR), cast(LPCWSTR), cast(LPWSTR), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) BuildCommDCBAndTimeoutsW(cast(LPCWSTR), LPDCB, LPCOMMTIMEOUTS);}
cast(BOOL) GetDefaultCommConfigW(cast(LPCWSTR), LPCOMMCONFIG, LPcast(DWORD));}
cast(BOOL) SetDefaultCommConfigW(cast(LPCWSTR), LPCOMMCONFIG, cast(DWORD));}
cast(BOOL) GetComputerNameW(cast(LPWSTR), LPcast(DWORD));}
cast(BOOL) SetComputerNameW(cast(LPCWSTR));}
cast(BOOL) GetUserNameW(cast(LPWSTR), LPcast(DWORD));}
...
cast(BOOL) GetUserObjectInformationW(cast(HANDLE), цел, PVOID, cast(DWORD), LPcast(DWORD));}
...
LRESULT SendMessageTimeoutW(HWND, UINT, WPARAM, LPARAM, UINT, UINT, LPcast(DWORD));}
...
cast(DWORD) GetFileVersionInfoSizeW(cast(LPWSTR), LPcast(DWORD));}
...
LONG RegQueryMultipleValuesW(HKEY, PVALENT, cast(DWORD), cast(LPWSTR), LPcast(DWORD));}
LONG RegQueryValueExW(HKEY, cast(LPCWSTR), LPcast(DWORD), LPcast(DWORD), LPBYTE, LPcast(DWORD));}
...
LONG RegCreateKeyExW(HKEY, cast(LPCWSTR), cast(DWORD), cast(LPWSTR), cast(DWORD), REGSAM, cast(LPSECURITY_ATTRIBUTES), PHKEY, LPcast(DWORD));}
...
LONG RegEnumKeyExW(HKEY, cast(DWORD), cast(LPWSTR), LPcast(DWORD), LPcast(DWORD), cast(LPWSTR), LPcast(DWORD), PFILETIME);}
LONG RegEnumValueW(HKEY, cast(DWORD), cast(LPWSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPBYTE, LPcast(DWORD));}
...
LONG RegQueryInfoKeyW(HKEY, cast(LPWSTR), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), PFILETIME);}
...
cast(BOOL) PeekConsoleInputW(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
cast(BOOL) ReadConsoleInputW(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
cast(BOOL) WriteConsoleInputW(cast(HANDLE), PINPUTRECORD, cast(DWORD), LPcast(DWORD));}
...
cast(BOOL) ReadConsoleOutputCharacterW(cast(HANDLE), cast(LPWSTR), cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) WriteConsoleOutputCharacterW(cast(HANDLE), cast(LPCWSTR), cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) FillConsoleOutputCharacterW(cast(HANDLE), WCHAR, cast(DWORD), COORD, LPcast(DWORD));}
...
cast(BOOL) ReadConsoleW(cast(HANDLE), cast(LPVOID), cast(DWORD), LPcast(DWORD), cast(LPVOID));}
cast(BOOL) WriteConsoleW(cast(HANDLE), LPVOID, cast(DWORD), LPcast(DWORD), cast(LPVOID));}
...
cast(DWORD) WNetGetConnectionW(cast(LPCWSTR), cast(LPWSTR), LPcast(DWORD));}
cast(DWORD) WNetUseConnectionW(HWND, LPNETRESOURCE, cast(LPCWSTR), cast(LPCWSTR), cast(DWORD), cast(LPWSTR), LPcast(DWORD), LPcast(DWORD));}
...
cast(DWORD) WNetEnumResourceW(cast(HANDLE), LPcast(DWORD), cast(LPVOID), LPcast(DWORD));}
cast(DWORD) WNetGetUniversalNameW(cast(LPCWSTR), cast(DWORD), cast(LPVOID), LPcast(DWORD));}
cast(DWORD) WNetGetUserW(cast(LPCWSTR), cast(LPWSTR), LPcast(DWORD));}
cast(DWORD) WNetGetProviderNameW(cast(DWORD), cast(LPWSTR), LPcast(DWORD));}
cast(DWORD) WNetGetNetworkInformationW(cast(LPCWSTR), LPNETINFOSTRUCT);}
cast(DWORD) WNetGetLastErrorW(LPcast(DWORD), cast(LPWSTR), cast(DWORD), cast(LPWSTR), cast(DWORD));}
cast(DWORD) MultinetGetConnectionPerformanceW(LPNETRESOURCE, LPNETCONNECTINFOSTRUCT);}
cast(BOOL) ChangeServiceConfigW(SC_cast(HANDLE), cast(DWORD), cast(DWORD), cast(DWORD), cast(LPCWSTR), cast(LPCWSTR), LPcast(DWORD), cast(LPCWSTR), cast(LPCWSTR), cast(LPCWSTR), cast(LPCWSTR));}
SC_cast(HANDLE) CreateServiceW(SC_cast(HANDLE), cast(LPCWSTR), cast(LPCWSTR), cast(DWORD), cast(DWORD), cast(DWORD), cast(DWORD), cast(LPCWSTR), cast(LPCWSTR), LPcast(DWORD), cast(LPCWSTR), cast(LPCWSTR), cast(LPCWSTR));}
cast(BOOL) EnumDependentServicesW(SC_cast(HANDLE), cast(DWORD), LPENUM_SERVICE_STATUS, cast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) EnumServicesStatusW(SC_cast(HANDLE), cast(DWORD), cast(DWORD), LPENUM_SERVICE_STATUS, cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) GetServiceKeyNameW(SC_cast(HANDLE), cast(LPCWSTR), cast(LPWSTR), LPcast(DWORD));}
cast(BOOL) GetServiceDisplayNameW(SC_cast(HANDLE), cast(LPCWSTR), cast(LPWSTR), LPcast(DWORD));}
...
cast(BOOL) QueryServiceConfigW(SC_cast(HANDLE), LPQUERY_SERVICE_CONFIG, cast(DWORD), LPcast(DWORD));}
cast(BOOL) QueryServiceLockStatusW(SC_cast(HANDLE), LPQUERY_SERVICE_LOCK_STATUS, cast(DWORD), LPcast(DWORD));}
...
UINT DdeInitializeW(LPcast(DWORD), PFNCALLBACK, cast(DWORD), cast(DWORD));}
...
cast(BOOL) AccessCheck(PSECURITY_DESCRIPTOR, cast(HANDLE), cast(DWORD), PGENERIC_MAPPING, PPRIVILEGE_SET, LPcast(DWORD), LPcast(DWORD), LPcast(BOOL));}
...
cast(BOOL) GetExitCodeThread(cast(HANDLE), LPcast(DWORD));}
...
cast(BOOL) ReadProcessMemory(cast(HANDLE), LPCVOID, cast(LPVOID), cast(DWORD), LPcast(DWORD));}
cast(BOOL) WriteProcessMemory(cast(HANDLE), cast(LPVOID), cast(LPVOID), cast(DWORD), LPcast(DWORD));}
...
cast(DWORD) GetFileSize(cast(HANDLE), LPcast(DWORD));}
...
cast(BOOL) GetHandleInformation(cast(HANDLE), LPcast(DWORD));}
...
cast(BOOL) GetCommConfig(cast(HANDLE), LPCOMMCONFIG, LPcast(DWORD));}
...
cast(BOOL) WaitCommEvent(cast(HANDLE), LPcast(DWORD), LPOVERLAPPED);}
cast(DWORD) SetTapePosition(cast(HANDLE), cast(DWORD), cast(DWORD), cast(DWORD), cast(DWORD), cast(BOOL));}
cast(DWORD) GetTapePosition(cast(HANDLE), cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
...
cast(DWORD) GetTapeParameters(cast(HANDLE), cast(DWORD), LPcast(DWORD), cast(LPVOID));}
...
cast(BOOL) SetNamedPipeHandleState(cast(HANDLE), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) GetNamedPipeInfo(cast(HANDLE), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) PeekNamedPipe(cast(HANDLE), cast(LPVOID), cast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
cast(BOOL) TransactNamedPipe(cast(HANDLE), cast(LPVOID), cast(DWORD), cast(LPVOID), cast(DWORD), LPcast(DWORD), LPOVERLAPPED);}
cast(BOOL) GetMailslotInfo(cast(HANDLE), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD), LPcast(DWORD));}
...
cast(BOOL) GetProcessShutdownParameters(LPcast(DWORD), LPcast(DWORD));}
...
cast(BOOL) GetKernelObjectSecurity(cast(HANDLE), SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, cast(DWORD), LPcast(DWORD));}
...
cast(BOOL) GetSecurityDescriptorControl(PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR_CONTROL, LPcast(DWORD));}
...
cast(BOOL) MakeSelfRelativeSD(PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR, LPcast(DWORD));}
cast(BOOL) MakeAbsoluteSD(PSECURITY_DESCRIPTOR, PSECURITY_DESCRIPTOR, LPcast(DWORD), PACL, LPcast(DWORD), PACL, LPcast(DWORD), PSID, LPcast(DWORD), PSID, LPcast(DWORD));}
...
cast(BOOL) GetUserObjectSecurity(cast(HANDLE), PSECURITY_INFORMATION, PSECURITY_DESCRIPTOR, cast(DWORD), LPcast(DWORD));}
...
цел BroadcastSystemMessage(cast(DWORD), LPcast(DWORD), UINT, WPARAM, LPARAM);}
...
cast(DWORD) GetWindowThreadProcessId(HWND, LPcast(DWORD));}
...
LONG RegGetKeySecurity(HKEY, SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, LPcast(DWORD));}
...
cast(BOOL) ReadConsoleOutputAttribute(cast(HANDLE), LPWORD, cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) WriteConsoleOutputAttribute(cast(HANDLE), бкрат*, cast(DWORD), COORD, LPcast(DWORD));}
cast(BOOL) FillConsoleOutputAttribute(cast(HANDLE), бкрат, cast(DWORD), COORD, LPcast(DWORD));}
...
cast(BOOL) GetNumberOfConsoleMouseButtons(LPcast(DWORD));}
...
cast(BOOL) QueryServiceObjectSecurity(SC_cast(HANDLE), SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, cast(DWORD), LPcast(DWORD));}
