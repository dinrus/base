...
class Текст(T) : ТекстОбзор!(T)
{
    ...
    private struct Поиск(T)
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает да if there is a сверь внутри the
                associated текст
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            in a ткст. Возвращает да if найдено, нет иначе
    ...
    ***********************************************************************/
    ...
    deprecated final Текст добавь (дво знач, бцел decimals=2, цел e=10)
    {
        T[64] врем =void;
        return добавь (Float.форматируй(врем, знач, decimals, e));
    }
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            the length of the предоставленный Массив, or the length of the
...
class ТекстОбзор(T) : ЮниТекст
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            of the предоставленный Массив, or the length of the контент
