/*******************************************************************************
    ...
    и связанных с ней мета-данных. Её можно применять для  plug in текст.локаль
    для обработки частных форматов, дата/время и специфичных для культуры
    преобразований.

    На стиль форматируй больше всего повлияли используемые в фреймворках .NET
...
Содержит методы для замены элементов форматируй в ткст на ткст
...
/+
    ...
    **********************************************************************/
    ...
    public бцел разбор (T[] выкладка, ИнфОТипе[] иот, Арг[] арги, Сток сток)
    {
        ...
        while (да)
        {
            ...
            // следщ сим is старт of following фрагмент
            фрагмент = ++s;
    ...
    **********************************************************************/
    ...
    protected T[] целое (T[] вывод, дол знач, T[] формат, бдол маска = бдол.max, T[] def="d")
    {
        ...
        return Целое.форматируй (вывод, знач, формат);
    }
    ...
    **********************************************************************/
    ...
    protected T[] плавающее (T[] вывод, реал знач, T[] формат)
    {
        ...
        return Плав.форматируй (вывод, знач, dec, эксп, пад);
    }
