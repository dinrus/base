    ...
    **********************************************************************/
    ...
    version (Windows)
    {
        ...
        **********************************************************************/
        ...
        {
            static ткст вТкст (ткст приёмн, ЛКИД опр, т_локаль тип)
            {
                шим[256] шир =void;

                auto длин = ДайИнфОЛокале (опр, тип, пусто, 0);
                if (длин && длин < шир.length)
                {
                    ДайИнфОЛокале (опр, тип, шир.ptr, шир.length);
        ...
        **********************************************************************/
        ...
        private static ткст преобразуй(ткст фмт)
        {
            ...
            for (auto i = 0; i < фмт.length; ++i)
            {
                ...
                case 'e': //день месяца as a decimal число [1,31];
                ...
                //(Воскресенье as первый день недели) as a decimal число [00,53]
                case 'З': //week число of the год
                //(Понедельник as первый день недели) as a decimal число [01,53].
                ...
                case 'j': //день годв as a decimal число [001,366]
                    assert(0);
                    break;
