...
/*******************************************************************************
        ...
        is known. These *must* be использован when converting задний в_ external кодировка, 
...
class BomSniffer 
{
        ...
        private struct  Инфо
                ...
                бул     тест,          // should we тест для этого кодировка?
        ...
        /***********************************************************************
                ...
                Возвращает текущ кодировка. This is either the originally
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Возвращает сигнатура (мпб) of the текущ кодировка
