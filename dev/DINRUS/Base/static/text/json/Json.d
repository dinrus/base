module text.джейсон.Json;

private import tpl.args;
private import io.model;
private import text.джейсон.JsonEscape;
private import text.джейсон.JsonParser;
...
class Джейсон(T) : private ПарсерДжейсон!(T)
{
        ...
        ***********************************************************************/
        ...
        private alias Разместитель!(ИмяЗначение)     Attrib;
        private alias Разместитель!(ЗначениеДжейсон)     Values;
        private alias Разместитель!(ОбъектДжейсон)    Objects;

        private Attrib                          атриб;
