...
/*******************************************************************************
        ...
        начало, whereupon it may be populated either by parsing an
        ...
        than иначе. We felt this was a reasonable tradeoff, given
        ...
        of the клиент. That is, the клиент should выполни appropriate
        ...
        doc.дерево.элемент   (пусто, "элемент")
                .атрибут (пусто, "attrib1", "значение")
                .атрибут (пусто, "attrib2")
        ...
        элемент instead. Например, добавим an interior sibling в_
        ...
        установи = doc.запрос.descendant.атрибут("attrib1");
        ...
        is limited unless you explicitly копируй it. Например, this will
        краш
        ---
        ...
        узел пространство for subsequent queries. In order в_ retain результатs, do this
        ---
...
class Документ(T) : package PullParser!(T)
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает пусто where there are no узелs in the document
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Возвращает пусто where there are no верх-уровень элемент узелs
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            узел внутри this document. The результатant дерево is retrieved
            via the document 'дерево' атрибут
    ...
    private struct Visitor
    {
        ...
        ***************************************************************/
        version (Фильтр)
        {
            ...
            {
                if (значение.ptr)
                    return имя (префикс, local, (Узел n)
                {
                    return значение == n.НеобрValue;
                });
    ...
    private struct NodeImpl
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Return the родитель, which may be пусто
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Detach this узел из_ its родитель и siblings
        ...
        ***************************************************************/
        ...
        Visitor атрибуты ()
        {
            Visitor знач = {firstAttr};
            return знач;
        }

        /***************************************************************

                Возвращает whether there are атрибуты present or not
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает whether there are ветви present or nor
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Возвращает reference в_ the subtree
        ...
        ***************************************************************/
        ...
        Узел атрибут (T[] префикс, T[] local, T[] значение = пусто)
        {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Доб an атрибут в_ this узел, The given атрибут
                cannot have an existing родитель.
        ...
        ***************************************************************/
        ...
        private Узел удали()
        {
            ...
            else if (nextSibling)
            {
                ...
                родитель.firstChild = nextSibling;
...
/*******************************************************************************
        ...
        In general, you traverse an axis и operate upon the результатs. The
        ...
        * the .узелs атрибут exposes an underlying Узел[], which may be
...
private class ПутьРЯР(T)
{
    ...
    /***********************************************************************
            ...
            Возвращает NodeSet containing just the given узел, which
            can then be использован в_ cascade результатs преобр_в subsequent NodeSet
            экземпляры.
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            also. This is just a convenience фактор, и doesn't
    ...
    struct NodeSet
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Return the число of selected узелs в этом наборе
        ...
        ***************************************************************/
        ...
        NodeSet атрибут (бул delegate(Узел) фильтр)
        {
            NodeSet установи = {хост};
            auto метка = хост.метка;
        ...
        ***************************************************************/
        ...
        NodeSet родитель (бул delegate(Узел) фильтр)
        {
            NodeSet установи = {хост};
            auto метка = хост.метка;
