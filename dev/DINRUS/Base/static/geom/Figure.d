...
public import sys.WinStructs, stdrus:
фм;
...
struct Прямоугольник
{
    ...
    {
        return opCall( Точка(0,0), размер );
    }
...
//............................
    Диапазон     ш()
    {
        return Диапазон(исх.ш,угол.ш);
    }
    Диапазон     в()
    {
        return Диапазон(исх.в,угол.в);
    }
    ...
    {
        return ш().содержит(p.ш) && в().содержит(p.в);
    }
    ...
    {
        return ш().накладывается(r.ш()) && в().накладывается(r.в());
    }
    ...
    бул      пуст_ли()
    {
        return ш().пуст_ли() || в().пуст_ли();
    };

    static Прямоугольник empty()
    {
        Прямоугольник r;
        r.очисть();
        return r;
    ...
    Точка     точкаУ(цел which)
    {
        ...
        case 3:
            return угол;
        case 1:
            return Точка(исх.ш,угол.в);
        case 9:
            return Точка(угол.ш,исх.в);
        case 8:
            return Точка(исх.ш + ширина/2,исх.в);
        case 2:
            return Точка(исх.ш + ширина/2,угол.в);
        case 4:
            return Точка(исх.ш,исх.в + высота/2);
        case 6:
            return Точка(угол.ш,исх.в + высота/2);
        case 5:
            return Точка(исх.ш + ширина/2,исх.в + высота/2);
        default:
            assert(false);
        }
    ...
    // and comments inside.
    проц точкаУ(цел which, Точка знач)
    {
        switch(which)
        {
        case 7:
        ...
        case 2:
            поз = Точка(знач.ш - ширина / 2, знач.в - высота + 1);
    ...
    ткст вТкст()
    {
        return фм("{%d,%d,%d,%d}", исх.ш, исх.в, угол.ш, угол.в);
    }
...
struct Точка
{
    ...
    Точка         opAdd(Точка p)
    {
        return opCall(x + p.x, y + p.y);
    }
    Точка         opAdd(Размер s)
    {
        return opCall(x + s.x, y + s.y);
    }
...
struct Размер
{
    ...
    Размер         opAdd(цел i)
    {
        return opCall(ширина + i, высота + i);
    }
    ...
    {
        return opCall(ширина + s.ширина, высота + s.высота);
    }
    ...
    {
        return opCall(i - ширина, i - высота);
    }
    ...
    Размер         opNeg()
    {
        return opCall(-ширина, -высота);
    }

    Размер         opAddAssign(цел i)
    {
        return ширина += i, высота += i, *this;
    }
    Размер         opAddAssign(Размер s)
    {
        return ширина += s.ширина, высота += s.высота, *this;
    }
    ...
    ткст вТкст()
    {
        return фм("{%d,%d}", ширина,высота);
    }
}

template min(T)
{
    T min(in T p1, in T p2)
    {
        return p1<p2?p1:p2;
    }
}
...
struct Диапазон
{
    ...
    {
        return (max!(цел)(н,r.н)) <= (min!(цел)(в,r.в));
    }
    ...
    {
        return opCall( max!(цел)(н,r.н), min!(цел)(в,r.в));
    }
    // union of two ranges r3 = r1 | r2;
    Диапазон opOr(Диапазон r)
    {
        return opCall( min!(цел)(н,r.н), max!(цел)(в,r.в));
    }
    ...
    {
        return н = max!(цел)(н,a.н), в = min!(цел)(в,a.в), *this;
    }
    // inplace union r1 |= r2;
...
{
    return r1.ш().накладывается(r2.ш()) && r1.в().накладывается(r2.в());
}
