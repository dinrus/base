...
/*******************************************************************************
        ...
        A установи of virtual папки. For a подст-дерево, we compose the результатs
...
/*******************************************************************************
        ...
        A установи of virtual файлы, represented by composing the результатs of
        the given установи of папки. Subsequent calls are delegated в_ the
        результатs из_ those папки
