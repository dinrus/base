        ...
        version (Posix)
        {
            while (да)
            {
                ...
                else
                {
                    ...
                    {
                        // проверьНомОш() всегда throws an исключение
...
version (Windows)
{
    ...
    private struct НаборДескр
    {
        ...
        /**
         *  return да, если this укз установи имеется been инициализован.
         */
        бул инициализован()
        {
        ...
        /**
         * Возвращает the число of handles present in the НаборДескр.
         */
        бцел length()
        {
            return _буфер[0];
