 ...
 ClassInfo c;
  ...
  //   скажинс(typeid(TL));	// prints: (A,I)
	...
	*********************************
	...
	Сборка мусора и остановка рантайма будут проведены   в необходимом
	порядке. Приносим  извинения, но в запущенном  вами    приложении,
	либо   в рантайме Динрус, есть какие-то несоответствия либо ошибки.					
	*************************************
	%s  %s
