...
АктивОбъ акс;
     this() {
	   ...
	   скажинс("Создан экземпляр InternetExplorer");
     }

     проц видимый(Вар значение) {
       акс.установи("Visible", значение);
	   скажинс("Установлен Видимым");
     }
     ...
     проц перейди(ткст урл) {
	скажинс("Переход на сайт "~урл);
       акс.вызови("Navigate", вар(урл));
	   скажинс("Вызов выполнен");
     }
	 
	 проц состав()
	 {
	 скажинс("Показать состав");
	 акс.покажиСостав();
	 	 скажинс("Показать выполнено");
	 }
...
проц тестКом() {
 /+  // Create an instance of the Excel application object and Устанавливает Visible property to true.
  ...
  /*
проц тестКОМ() {
IShellDispatch оболочка;
оболочка.создайКо!(IShellDispatch);
