 ...
 class Thread
{
    ...
    /**
     * Constructor used by classes derived from DThread that override main(). 
    ...
    /**
     * Constructor used by classes derived from DThread that override run().
     */
    this(int (*fp)(void *), void *arg, size_t stacksize = 0)
    {
	this.fp = fp;
   ...
   void start()
     ...
     * dg.
     * Возвращает: the thread exit code, which is normally 0.
     */
...
extern (C) uint dThreadsNumber(){return Thread.nthreads;}
