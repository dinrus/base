...
private import std.ctype, os.windows;
...
private class MangleException : Exception
{
	...
	wchar* soob =cast(wchar*)"Неудачное деманглирование символов библиотеки\n";
	ОкноСооб(null, cast(wchar*) soob, "D рантайм:ИсключениеДеманглирования", СО_ОК|СО_ПИКТОШИБКА);
    }
}
