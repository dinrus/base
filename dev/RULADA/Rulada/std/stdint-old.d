...
/**
 *
	D ограничивает интегральные типы до определенных размеров. Но эффективность
	различных типов зависит от конечной машины,
	размеры указателей различаются, и различается максимальный размер целого числа.
