...
public import auxc.ft.def;

private 
{
	import auxc.ft.loader;
	debug import std.io;
	import std.stream;
}
...
void onLoadFailure( char[] symName )
{
	...
	std.io.writefln( count, "Warning! Failed to load: ", symName );
}
...
static this()
{
	...
	version(linux)	 freetype_Linker = new Linker("libauxc.ft.so", &onLoadFailure );
...
auxc.ft.loader.Symbol[] freetypeLinks =
[
