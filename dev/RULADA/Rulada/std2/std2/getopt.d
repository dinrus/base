...
Single-letter options can be bundled together, i.e. "-abc" то же самое, что "-a -b -c". By default, this confusing option is turned off. You can turn it on with the $(D_PARAM std.getopt.config.bundling) directive:
