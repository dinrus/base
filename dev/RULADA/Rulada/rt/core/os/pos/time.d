 ...
 */
module rt.core.pos.sys.time;

private import rt.core.pos.sys.config;
public import rt.core.stdc.time;
public import rt.core.pos.sys.sys.types;
public import rt.core.pos.sys.signal; // for sigevent

extern  (C):

//
// Required (defined in rt.core.stdc.time)
//
/*
char* asctime(in tm*);
clock_t clock();
...
NOTE: timespec must be defined in rt.core.pos.sys.signal to break
      a circular import.
...
{
    const CLOCK_THREAD_CPUTIME_ID    = 15;
