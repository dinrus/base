 ...
 */
module rt.core.pos.sys.netinet.in_;

private import rt.core.pos.sys.config;
public import rt.core.stdc.inttypes; // for uint32_t, uint16_t, uint8_t
public import rt.core.pos.sys.arpa.inet;
public import rt.core.pos.sys.sys.socket; // for sa_family_t
...
//
/*
NOTE: The following must must be defined in rt.core.pos.sys.arpa.inet to break
      a circular import: in_port_t, in_addr_t, struct in_addr, INET_ADDRSTRLEN.

in_port_t
in_addr_t

sa_family_t // from rt.core.pos.sys.sys.socket
uint8_t     // from rt.core.stdc.inttypes
...
htonl() // from rt.core.pos.sys.arpa.inet
htons() // from rt.core.pos.sys.arpa.inet
ntohl() // from rt.core.pos.sys.arpa.inet
ntohs() // from rt.core.pos.sys.arpa.inet
*/
...
else version( FreeBSD )
{
    ...
    const IPPROTO_IPV6        = 41; // <netinet/in.h>
    ...
    {
        return (*cast(uint32_t*) cast(void*) (&a.s6_addr[0]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[4]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[8]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[12]) == 0);
    }
    ...
    extern  (D) int IN6_IS_ADDR_LOOPBACK( in in6_addr* a )
    {
        return (*cast(uint32_t*) cast(void*) (&a.s6_addr[0]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[4]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[8]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[12]) == ntohl(1));
    }
    ...
    extern  (D) int IN6_IS_ADDR_V4MAPPED( in in6_addr* a )
    {
        return (*cast(uint32_t*) cast(void*) (&a.s6_addr[0]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[4]) == 0) &&
               (*cast(uint32_t*) cast(void*) (&a.s6_addr[8]) == ntohl(0x0000ffff));
    }
