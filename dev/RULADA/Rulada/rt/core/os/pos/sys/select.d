 ...
 */
module rt.core.pos.sys.sys.select;

private import rt.core.pos.sys.config;
public import rt.core.stdc.time;           // for timespec
public import rt.core.pos.sys.sys.time;  // for timeval
public import rt.core.pos.sys.sys.types; // for time_t
public import rt.core.pos.sys.signal;    // for sigset_t
...
//
/*
NOTE: This module requires timeval from rt.core.pos.sys.sys.time, but timeval
...
version( linux )
{
    private
    {
        ...
        const uint __NFDBITS = 8 * __fd_mask.sizeof;
...
else version( FreeBSD )
{
    private
    {
        ...
        const _NFDBITS = __fd_mask.sizeof * 8;
    }
