 ...
 */
module rt.core.pos.sys.sys.types;

private import rt.core.pos.sys.config;
private import rt.core.stdc.stdint;
public import rt.core.stdc.stddef; // for size_t
public import rt.core.stdc.time;   // for clock_t, time_t
...
version( linux )
{
  ...
  else
  {
    ...
    alias int       pid_t;
    //size_t (defined in rt.core.stdc.stddef)
    alias c_long    ssize_t;
    //time_t (defined in rt.core.stdc.time)
    alias uint      uid_t;
}
else version( OSX )
{
...
version( linux )
{
  ...
  else
  {
    ...
    // clock_t (defined in rt.core.stdc.time)
    alias uint      id_t;
    alias int       key_t;
