 ...
 */
module rt.core.pos.sys.pthread;

private import rt.core.pos.sys.config;
public import rt.core.pos.sys.sys.types;
public import rt.core.pos.sys.sched;
public import rt.core.pos.sys.time;
...
else version( FreeBSD )
{
    ...
    const PTHREAD_NEEDS_INIT = 0;
    const PTHREAD_DONE_INIT  = 1;

    //const PTHREAD_ONCE_INIT = { PTHREAD_NEEDS_INIT, null };

    const PTHREAD_MUTEX_INITIALIZER              = null;
    const PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP  = null;
    const PTHREAD_COND_INITIALIZER               = null;
    const PTHREAD_RWLOCK_INITIALIZER             = null;
}
