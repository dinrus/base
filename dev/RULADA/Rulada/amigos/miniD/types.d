...
align(1) struct MDValue
{
	...
	*/
	...
	package static char[] typeString(MDValue.Type t)
	{
		switch(t)
		{
			case Type.Null:      return "пусто";
			case Type.Bool:      return "бул";
			case Type.Int:       return "цел";
			case Type.Float:     return "плав";
			case Type.Char:      return "сим";

			case Type.String:    return "ткст";
			case Type.Table:     return "табль";
			case Type.Array:     return "массив";
			case Type.Function:  return "функ";
			case Type.Class:     return "класс";
			case Type.Instance:  return "экземпл";
			case Type.Namespace: return "зоним";
			case Type.Thread:    return "нить";
			case Type.NativeObj: return "искоб";
			case Type.WeakRef:   return "слабссыл";

			case Type.Upvalue:   return "верхзнач";
			case Type.FuncDef:   return "опредфункц";
			case Type.ArrayData: return "массивдан";
...
[
	...
	MM.Inc:          "opInc",
	MM.Index:        "опИндекс",
	MM.IndexAssign:  "опПрисвоитьИндекс",
	MM.Length:       "opLength",
	MM.LengthAssign: "опПрисвоитьДлину",
	MM.Method:       "opMethod",
	MM.Mod:          "opMod",
	MM.Mod_r:        "opMod_r",
	...
	MM.Slice:        "опСрез",
	MM.SliceAssign:  "опПрисвоитьСрез",
	MM.Sub:          "opSub",
	MM.Sub_r:        "opSub_r",
