...
interface ITuningSpaceContainer : IDispatch {
  ...
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IconstVARIANT Newconst);
  ...
  // Convenience Function for consterating from C
  ...
  // Convenience Function for consterating collection from C
  /*[id(0x60020009)]*/ int get_constTuningSpaces(out IconstTuningSpaces ppconst);
...
interface ITuningSpace : IDispatch {
  ...
  /*[id(0x00000007)]*/ int constCategoryGUIDs(out IconstGUID ppconst);
  /*[id(0x00000008)]*/ int constDeviceMonikers(out IconstMoniker ppconst);
...
interface IComponents : IDispatch {
  ...
  // Number of items in the collection
  /*[id(0x60020000)]*/ int get_Count(out int Count);
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IconstVARIANT ppNewconst);
  // Convenience Function for Use with C
  /*[id(0x60020002)]*/ int constComponents(out IconstComponents ppNewconst);
...
interface IconstComponents : IUnknown {
  ...
  /*[id(0x60010003)]*/ int Clone(out IconstComponents ppconst);
}
...
interface IconstMoniker : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Skip(uint celt);
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstMoniker ppconst);
}
...
interface IMoniker : IPersistStream {
  ...
  /*[id(0x60030004)]*/ int Enum(int fForward, out IconstMoniker ppconstMoniker);
...
interface IBindCtx : IUnknown {
  ...
  /*[id(0x60010008)]*/ int constObjectParam(out IconstString ppconst);
...
interface IRunningObjectTable : IUnknown {
  ...
  /*[id(0x60010006)]*/ int constRunning(out IconstMoniker ppconstMoniker);
}

interface IconstString : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Skip(uint celt);
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstString ppconst);
}
...
interface IComponentTypes : IDispatch {
  ...
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IconstVARIANT ppNewconst);
  // Convenience Function for Use with C
  /*[id(0x60020002)]*/ int constComponentTypes(out IconstComponentTypes ppNewconst);
...
interface IconstComponentTypes : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Skip(uint celt);
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstComponentTypes ppconst);
}
...
interface ITuningSpaces : IDispatch {
  ...
  /*[id(0x60020003)]*/ int get_constTuningSpaces(out IconstTuningSpaces Newconst);
}

interface IconstTuningSpaces : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Skip(uint celt);
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstTuningSpaces ppconst);
}
...
interface ITuner : IUnknown {
  ...
  // Returns an consterator for Tuning Spaces accepted by this tuner
  /*[id(0x60010002)]*/ int constTuningSpaces(out IconstTuningSpaces ppconst);
  // Tune Request object
...
interface IFilterGraph : IUnknown {
  ...
  /*[id(0x60010002)]*/ int constFilters(out IconstFilters ppconst);
...
interface IBaseFilter : IMediaFilter {
  ...
  /*[id(0x60030000)]*/ int constPins(out IconstPins ppconst);
...
interface IconstPins : IUnknown {
  ...
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstPins ppconst);
}
...
interface IPin : IUnknown {
  ...
  /*[id(0x60010009)]*/ int constMediaTypes(out IconstMediaTypes ppconst);
...
interface IconstMediaTypes : IUnknown {
  ...
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstMediaTypes ppconst);
}

interface IconstFilters : IUnknown {
  ...
  /*[id(0x60010002)]*/ int Reset();
  /*[id(0x60010003)]*/ int Clone(out IconstFilters ppconst);
}
