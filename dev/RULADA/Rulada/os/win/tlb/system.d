...
interface IEventBindingService : IDispatch {
  ...
  /*[id(0x60020006)]*/ int ShowCode_2(int linconstber, out short pRetVal);
...
abstract final class CodeExpressionCollection {
  ...
  mixin Interfaces!(_CodeExpressionCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeAttributeArgumentCollection {
  ...
  mixin Interfaces!(_CodeAttributeArgumentCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeAttributeDeclarationCollection {
  ...
  mixin Interfaces!(_CodeAttributeDeclarationCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeStatementCollection {
  ...
  mixin Interfaces!(_CodeStatementCollection, _Object, IList, ICollection, Iconsterable);
}

abstract final class CodeCatchClauseCollection {
  mixin(uuid("2077ecf3-61c8-3cc5-9e45-721189a88e03"));
  mixin Interfaces!(_CodeCatchClauseCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeCommentStatementCollection {
  ...
  mixin Interfaces!(_CodeCommentStatementCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeNamespaceCollection {
  ...
  mixin Interfaces!(_CodeNamespaceCollection, _Object, IList, ICollection, Iconsterable);
}

abstract final class CodeDirectiveCollection {
  mixin(uuid("ed78c3fa-ab56-353c-98bb-9280d3404c81"));
  mixin Interfaces!(_CodeDirectiveCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeTypeReferenceCollection {
  ...
  mixin Interfaces!(_CodeTypeReferenceCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeParameterDeclarationExpressionCollection {
  ...
  mixin Interfaces!(_CodeParameterDeclarationExpressionCollection, _Object, IList, ICollection, Iconsterable);
}

abstract final class CodeTypeParameterCollection {
  mixin(uuid("6019c9d4-84cb-33bc-9e79-25f21172c33b"));
  mixin Interfaces!(_CodeTypeParameterCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeTypeDeclarationCollection {
  ...
  mixin Interfaces!(_CodeTypeDeclarationCollection, _Object, IList, ICollection, Iconsterable);
}

abstract final class CodeNamespaceImportCollection {
  mixin(uuid("7a168834-5605-30db-8274-6b21e621a955"));
  mixin Interfaces!(_CodeNamespaceImportCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class CodeTypeMemberCollection {
  ...
  mixin Interfaces!(_CodeTypeMemberCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class DesignerVerbCollection {
  ...
  mixin Interfaces!(_DesignerVerbCollection, _Object, IList, ICollection, Iconsterable);
}
...
abstract final class WebHeaderCollection {
  ...
  mixin Interfaces!(_WebHeaderCollection, _Object, ICollection, Iconsterable, ISerializable, IDeserializationCallback);
}
