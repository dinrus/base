...
interface ITCollection : IDispatch {
  ...
  // returns an consterator for the collection.
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown ppNewconst);
}
...
interface ITAddress : IDispatch {
  ...
  // method consterateCalls
  /*[id(0x00010007)]*/ int consterateCalls(out IconstCall ppCallconst);
...
interface ITTAPI : IDispatch {
  ...
  // method consterateAddresses
  /*[id(0x00010002)]*/ int consterateAddresses(out IconstAddress ppconstAddress);
  ...
  // method consterateCallHubs
  /*[id(0x00010006)]*/ int consterateCallHubs(out IconstCallHub ppconstCallHub);
  // method SetCallHubTracking
  /*[id(0x00010007)]*/ int SetCallHubTracking(VARIANT pAddresses, short bTracking);
  /*[id(0x00010008)]*/ int consteratePrivateTAPIObjects(out IconstUnknown ppconstUnknown);
...
// TAPI 3.0 IconstAddress interface
interface IconstAddress : IUnknown {
  ...
  /*[id(0x60010003)]*/ int Clone(out IconstAddress ppconst);
}

// TAPI 3.0 IconstCallHub interface
interface IconstCallHub : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstCallHub ppconst);
}
...
interface ITCallHub : IDispatch {
  ...
  // method consterateCalls
  /*[id(0x00000002)]*/ int consterateCalls(out IconstCall ppconstCall);
  // property Calls
...
// TAPI 3.0 IconstCall interface
interface IconstCall : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstCall ppconst);
}

interface IconstUnknown : IUnknown {
  ...
  /*[id(0x60010003)]*/ int Clone(out IconstUnknown ppconst);
}
...
interface ITAddressCapabilities : IDispatch {
  ...
  /*[id(0x00020004)]*/ int consterateCallTreatments(out IconstBstr ppconstCallTreatment);
  // property CompletionMessages
  /*[id(0x00020005)]*/ int get_CompletionMessages(out VARIANT pVariant);
  /*[id(0x00020006)]*/ int consterateCompletionMessages(out IconstBstr ppconstCompletionMessage);
  // property DeviceClasses
  /*[id(0x00020007)]*/ int get_DeviceClasses(out VARIANT pVariant);
  /*[id(0x00020008)]*/ int consterateDeviceClasses(out IconstBstr ppconstDeviceClass);
}

// TAPI 3.0 IconstBstr interface
interface IconstBstr : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstBstr ppconst);
}
...
interface ITStream : IDispatch {
  ...
  /*[id(0x00000009)]*/ int consterateTerminals(out IconstTerminal ppconstTerminal);
  // property Terminals
  /*[id(0x0000000A)]*/ int get_Terminals(out VARIANT pTerminals);
}

// TAPI 3.0 IconstTerminal Interface
interface IconstTerminal : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstTerminal ppconst);
}
...
interface ITPhone : IDispatch {
  ...
  // method consterateAddresses
  /*[id(0x00010004)]*/ int consterateAddresses(out IconstAddress ppconstAddress);
  ...
  // method consterateTerminals
  /*[id(0x00010008)]*/ int consterateTerminals(ITAddress pAddress, out IconstTerminal ppconstTerminal);
  // property ButtonMode
  ...
  // method consteratePreferredAddresses
  /*[id(0x00010017)]*/ int consteratePreferredAddresses(out IconstAddress ppconstAddress);
...
interface ITAddressTranslation : IDispatch {
  ...
  // method consterateLocations
  /*[id(0x00040003)]*/ int consterateLocations(out IconstLocation ppconstLocation);
  // property Locations
  /*[id(0x00040004)]*/ int get_Locations(out VARIANT pVariant);
  // method consterateCallingCards
  /*[id(0x00040005)]*/ int consterateCallingCards(out IconstCallingCard ppconstCallingCard);
...
// TAPI 3.0 IconstLocation interface
interface IconstLocation : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstLocation ppconst);
}
...
// TAPI 3.0 IconstCallingCard interface
interface IconstCallingCard : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstCallingCard ppconst);
}
...
interface ITAgent : IDispatch {
  ...
  // method consterateAgentSessions
  /*[id(0x00000001)]*/ int consterateAgentSessions(out IconstAgentSession ppconstAgentSession);
...
// TAPI 3.0 IconstAgentSession interface
interface IconstAgentSession : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstAgentSession ppconst);
}
...
interface ITACDGroup : IDispatch {
  ...
  // property Name
  /*[id(0x00000001)]*/ int get_Name(out wchar* ppName);
  // method consterateQueues
  /*[id(0x00000002)]*/ int consterateQueues(out IconstQueue ppconstQueue);
  // property Queues
  /*[id(0x00000003)]*/ int get_Queues(out VARIANT pVariant);
}

// TAPI 3.0 IconstQueue interface
interface IconstQueue : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstQueue ppconst);
}
...
interface ITTAPICallCenter : IDispatch {
  ...
  // method consterateAgentHandlers
  /*[id(0x00020001)]*/ int consterateAgentHandlers(out IconstAgentHandler ppconstHandler);
  // property AgentHandlers
  /*[id(0x00020002)]*/ int get_AgentHandlers(out VARIANT pVariant);
}

// TAPI 3.0 IconstAgentHandler interface
interface IconstAgentHandler : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstAgentHandler ppconst);
}
...
interface ITAgentHandler : IDispatch {
  ...
  // method consterateACDGroups
  /*[id(0x00000004)]*/ int consterateACDGroups(out IconstACDGroup ppconstACDGroup);
  // method consterateUsableAddresses
  /*[id(0x00000005)]*/ int consterateUsableAddresses(out IconstAddress ppconstAddress);
  // property ACDGroups
...
// TAPI 3.0 IconstACDGroup interface
interface IconstACDGroup : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstACDGroup ppconst);
}
...
interface ITTerminalSupport : IDispatch {
  ...
  // method consterateStaticTerminals
  /*[id(0x00060002)]*/ int consterateStaticTerminals(out IconstTerminal ppTerminalconsterator);
  // property DynamicTerminalClasses
  /*[id(0x00060003)]*/ int get_DynamicTerminalClasses(out VARIANT pVariant);
  // method consterateDynamicTerminalClasses
  /*[id(0x00060004)]*/ int consterateDynamicTerminalClasses(out IconstTerminalClass ppTerminalClassconsterator);
...
// TAPI 3.0 IconstTerminalClass interface
interface IconstTerminalClass : IUnknown {
  mixin(uuid("ae269cf5-935e-11d0-835c-00aa003ccabd"));
  /*[id(0x60010000)]*/ int Next(uint celt, out GUID pElements, ref uint pceltFetched);
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstTerminalClass ppconst);
}
...
interface ITTerminalSupport2 : ITTerminalSupport {
  ...
  // method consteratePluggableSuperclasses
  /*[id(0x00060008)]*/ int consteratePluggableSuperclasses(out IconstPluggableSuperclassInfo ppSuperclassconsterator);
  ...
  // method consteratePluggableTerminalClasses
  /*[id(0x0006000A)]*/ int consteratePluggableTerminalClasses(GUID iidTerminalSuperclass, int lMediaType, out IconstPluggableTerminalClassInfo ppClassconsterator);
}

// TAPI 3.1 IconstPluggableSuperclassInfo interface
interface IconstPluggableSuperclassInfo : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstPluggableSuperclassInfo ppconst);
}
...
// TAPI 3.1 IconstPluggableTerminalClassInfo interface
interface IconstPluggableTerminalClassInfo : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstPluggableTerminalClassInfo ppconst);
}
...
interface ITStreamControl : IDispatch {
  ...
  /*[id(0x00040003)]*/ int consterateStreams(out IconstStream ppconstStream);
  // property Streams
  /*[id(0x00040004)]*/ int get_Streams(out VARIANT pVariant);
}

// IconstStream interface
interface IconstStream : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstStream ppconst);
}
...
interface ITSubStreamControl : IDispatch {
  ...
  /*[id(0x00000003)]*/ int consterateSubStreams(out IconstSubStream ppconstSubStream);
  // property SubStreams
...
interface ITSubStream : IDispatch {
  ...
  /*[id(0x00000006)]*/ int consterateTerminals(out IconstTerminal ppconstTerminal);
  // property Terminals
...
// IconstSubStream interface
interface IconstSubStream : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstSubStream ppconst);
}
...
interface ITAddress2 : ITAddress {
  ...
  // method consteratePhones
  /*[id(0x00010011)]*/ int consteratePhones(out IconstPhone ppconstPhone);
  ...
  // method consteratePreferredPhones
  /*[id(0x00010015)]*/ int consteratePreferredPhones(out IconstPhone ppconstPhone);
  // method EventFilter
...
// TAPI 3.1 IconstPhone Interface
interface IconstPhone : IUnknown {
  ...
  /*[id(0x60010001)]*/ int Reset();
  /*[id(0x60010002)]*/ int Skip(uint celt);
  /*[id(0x60010003)]*/ int Clone(out IconstPhone ppconst);
}
...
interface ITMultiTrackTerminal : IDispatch {
  ...
  // method consterateTrackTerminals
  /*[id(0x00010002)]*/ int consterateTrackTerminals(out IconstTerminal ppconstTerminal);
...
interface ITAutomatedPhoneControl : IDispatch {
  ...
  // method consterateSelectedCalls
  /*[id(0x00020014)]*/ int consterateSelectedCalls(out IconstCall ppCallconst);
...
const int LINEADDRESSTYPE_PHONconstBER = 0x00000001;
