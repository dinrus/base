...
// Defines depth of consteration or query
...
interface ISWbemServices : IDispatch {
  ...
  // consterate the Instances of a Class
  ...
  // consterate the Instances of a Class asynchronously
  ...
  // consterate the subclasses of a Class
  ...
  // consterate the subclasses of a Class asynchronously 
...
interface ISWbemSecurity : IDispatch {
  ...
  /*[id(0x00000001)]*/ int get_ImpersonationLevel(out WbemImpersonationLevelconst iImpersonationLevel);
  // The security impersonation level
  /*[id(0x00000001)]*/ int put_ImpersonationLevel(WbemImpersonationLevelconst iImpersonationLevel);
  // The security authentication level
  /*[id(0x00000002)]*/ int get_AuthenticationLevel(out WbemAuthenticationLevelconst iAuthenticationLevel);
  // The security authentication level
  /*[id(0x00000002)]*/ int put_AuthenticationLevel(WbemAuthenticationLevelconst iAuthenticationLevel);
...
interface ISWbemPrivilegeSet : IDispatch {
  ...
  /*[id(0x00000000)]*/ int Item(WbemPrivilegeconst iPrivilege, out ISWbemPrivilege objWbemPrivilege);
  // The number of items in this collection
  /*[id(0x00000001)]*/ int get_Count(out int iCount);
  // Add a Privilege to this collection
  /*[id(0x00000002)]*/ int Add(WbemPrivilegeconst iPrivilege, short bIsEnabled, out ISWbemPrivilege objWbemPrivilege);
  // Remove a Privilege from this collection
  /*[id(0x00000003)]*/ int Remove(WbemPrivilegeconst iPrivilege);
  // Delete all items in this collection
...
interface ISWbemPrivilege : IDispatch {
  ...
  /*[id(0x00000003)]*/ int get_Identifier(out WbemPrivilegeconst iPrivilege);
}
...
interface ISWbemPropertySet : IDispatch {
  ...
  /*[id(0x00000002)]*/ int Add(wchar* strName, WbemCimtypeconst iCimType, short bIsArray, int iFlags, out ISWbemProperty objWbemProperty);
...
interface ISWbemProperty : IDispatch {
  ...
  /*[id(0x00000004)]*/ int get_CIMType(out WbemCimtypeconst iCimType);
...
interface ISWbemSinkEvents : IDispatch {
  ...
  /*[id(0x00000002)]*/ void OnCompleted(WbemErrorconst iHResult, ISWbemObject objWbemErrorObject, ISWbemNamedValueSet objWbemAsyncContext);+/
...
interface ISWbemObjectEx : ISWbemObject {
  ...
  /*[id(0x0000001C)]*/ int GetText_(WbemObjectTextFormatconst iObjectTextFormat, int iFlags, IDispatch objWbemNamedValueSet, out wchar* bsText);
  // Set this Object using the supplied textual representation
  /*[id(0x0000001D)]*/ int SetFromText_(wchar* bsText, WbemObjectTextFormatconst iObjectTextFormat, int iFlags, IDispatch objWbemNamedValueSet);
}
...
interface ISWbemRefresher : IDispatch {
  ...
  // Add a refreshable consterator to this refresher
  /*[id(0x00000003)]*/ int Addconst(ISWbemServicesEx objWbemServices, wchar* bsClassName, int iFlags, IDispatch objWbemNamedValueSet, out ISWbemRefreshableItem objWbemRefreshableItem);
