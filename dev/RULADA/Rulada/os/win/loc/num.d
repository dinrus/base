...
private const string positivconstberFormat = "#";
// Must match NumberFormat.decimalNegativePattern
private const string[] negativconstberFormats = [ "(#)", "-#", "- #", "#-", "# -" ];
...
private void formatNumber(ref Number number, ref string dst, int length, NumberFormat nf) {
  string format = number.sign ? negativconstberFormats[1] : positivconstberFormat;
