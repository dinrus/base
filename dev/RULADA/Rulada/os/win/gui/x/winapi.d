...
extern(Windows):
	...
	import os.win.base.native: RT_STRING;// 
	//RT_STRING = cast(LPCSTR)6;
	...
	BOOL constWindows(WNDconstPROC lpconstFunc, LPARAM lParam);
	BOOL constChildWindows(HWND hWndParent, WNDconstPROC lpconstFunc, LPARAM lParam);
	...
	LONG RegconstKeyExW(HKEY hKey, DWORD dwIndex, LPWSTR lpName, LPDWORD lpcbName, LPDWORD lpReserved, LPWSTR lpClass, LPDWORD lpcbClass, PFILETIME lpftLastWriteTime);
	LONG RegconstValueW(HKEY hKey, DWORD dwIndex, LPTSTR lpValueName, LPDWORD lpcbValueName, LPDWORD lpReserved, LPDWORD lpType, LPBYTE lpData, LPDWORD lpcbData);
