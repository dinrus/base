...
extern(C)
{
	...
	version(REDEFINE_UUIDS)
	{
		...
		IID _IID_IconstFORMATETC = { 259, 0, 0, [ 192, 0, 0, 0, 0, 0, 0, 70 ] };
	}
	else
	{
		...
		alias IID_IconstFORMATETC _IID_IconstFORMATETC;
	}
}
...
// TODO: implement the const`s used here.
struct STATSTG
{
	LPWSTR pwcsName;
	DWORD type;
...
interface IconstSTATDATA: IUnknown
{
	...
	HRESULT Skip(ULONG celt);
	HRESULT Reset();
	HRESULT Clone(IconstSTATDATA* ppconst);
}
