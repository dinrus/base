 ...
 */
module rt.core.pos.sys.signal;

private import rt.core.pos.sys.config;
public import rt.core.stdc.signal;
public import rt.core.stdc.stddef;         // for size_t
public import rt.core.pos.sys.sys.types; // for pid_t
//public import rt.core.pos.sys.time;      // for timespec, now defined here
...
//
/*
SIG_DFL (defined in rt.core.stdc.signal)
SIG_ERR (defined in rt.core.stdc.signal)
SIG_IGN (defined in rt.core.stdc.signal)

sig_atomic_t (defined in rt.core.stdc.signal)
...
SIGABRT (defined in rt.core.stdc.signal)
SIGALRM
SIGBUS
SIGCHLD
SIGCONT
SIGFPE (defined in rt.core.stdc.signal)
SIGHUP
SIGILL (defined in rt.core.stdc.signal)
SIGINT (defined in rt.core.stdc.signal)
SIGKILL
SIGPIPE
SIGQUIT
SIGSEGV (defined in rt.core.stdc.signal)
SIGSTOP
SIGTERM (defined in rt.core.stdc.signal)
SIGTSTP
SIGTTIN
SIGTTOU
SIGUSR1
...
sigfn_t signal(int sig, sigfn_t func); (defined in rt.core.stdc.signal)
int raise(int sig);                    (defined in rt.core.stdc.signal)
*/
...
version( linux )
{
    ...
    //ucontext_t (defined in rt.core.pos.sys.ucontext)
    //mcontext_t (defined in rt.core.pos.sys.ucontext)
...
//
/*
NOTE: This should actually be defined in rt.core.pos.sys.time.
