...
{
    import std.string;
    import rt.core.stdc.string : memset, memcpy, strlen;
    import rt.core.stdc.stdlib : malloc, free, exit, strtoul, strtoull, qsort, 
                                EXIT_FAILURE;
    import rt.core.stdc.ctype : isspace, isalpha, isgraph;
    import rt.core.stdc.stdio : fopen, fclose, fprintf, fgetc, FILE, EOF;
}
