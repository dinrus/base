...
enum StringComparison {
  ...
  ТекущаяКультура = StringComparison_CurrentCulture,
  ТекущаяКультураИгнорРег = StringComparison_CurrentCultureIgnoreCase,
  ИнвариантКультура = StringComparison_InvariantCulture,
  ИнварианКультураИгнорРег = StringComparison_InvariantCultureIgnoreCase,
  Порядковый = StringComparison_Ordinal,
  ПорядковыйИгнорРег = StringComparison_OrdinalIgnoreCase,
...
enum DateTimeKind {
  ...
  Неуказано = DateTimeKind_Unspecified,
  Утс = DateTimeKind_Utc,
  Локальный = DateTimeKind_Local,
...
enum AttributeTargets {
  ...
  AttributeTargets_const = 0x00000010,
...
enum Varenum {
  Varconst_VT_EMPTY = 0x00000000,
  Varconst_VT_NULL = 0x00000001,
  Varconst_VT_I2 = 0x00000002,
  Varconst_VT_I4 = 0x00000003,
  Varconst_VT_R4 = 0x00000004,
  Varconst_VT_R8 = 0x00000005,
  Varconst_VT_CY = 0x00000006,
  Varconst_VT_DATE = 0x00000007,
  Varconst_VT_BSTR = 0x00000008,
  Varconst_VT_DISPATCH = 0x00000009,
  Varconst_VT_ERROR = 0x0000000A,
  Varconst_VT_BOOL = 0x0000000B,
  Varconst_VT_VARIANT = 0x0000000C,
  Varconst_VT_UNKNOWN = 0x0000000D,
  Varconst_VT_DECIMAL = 0x0000000E,
  Varconst_VT_I1 = 0x00000010,
  Varconst_VT_UI1 = 0x00000011,
  Varconst_VT_UI2 = 0x00000012,
  Varconst_VT_UI4 = 0x00000013,
  Varconst_VT_I8 = 0x00000014,
  Varconst_VT_UI8 = 0x00000015,
  Varconst_VT_INT = 0x00000016,
  Varconst_VT_UINT = 0x00000017,
  Varconst_VT_VOID = 0x00000018,
  Varconst_VT_HRESULT = 0x00000019,
  Varconst_VT_PTR = 0x0000001A,
  Varconst_VT_SAFEARRAY = 0x0000001B,
  Varconst_VT_CARRAY = 0x0000001C,
  Varconst_VT_USERDEFINED = 0x0000001D,
  Varconst_VT_LPSTR = 0x0000001E,
  Varconst_VT_LPWSTR = 0x0000001F,
  Varconst_VT_RECORD = 0x00000024,
  Varconst_VT_FILETIME = 0x00000040,
  Varconst_VT_BLOB = 0x00000041,
  Varconst_VT_STREAM = 0x00000042,
  Varconst_VT_STORAGE = 0x00000043,
  Varconst_VT_STREAMED_OBJECT = 0x00000044,
  Varconst_VT_STORED_OBJECT = 0x00000045,
  Varconst_VT_BLOB_OBJECT = 0x00000046,
  Varconst_VT_CF = 0x00000047,
  Varconst_VT_CLSID = 0x00000048,
  Varconst_VT_VECTOR = 0x00001000,
  Varconst_VT_ARRAY = 0x00002000,
  Varconst_VT_BYREF = 0x00004000,
}
...
interface Iconsterable : IDispatch {
  mixin(uuid("496b0abe-cdee-11d3-88e8-00902754c43a"));
  /*[id(0xFFFFFFFC)]*/ int Getconsterator(out IconstVARIANT pRetVal);
}
...
interface Iconsterator : IDispatch {
...
interface _Type : IUnknown {
  ...
  /*[id(0x60010060)]*/ int get_Isconst(out short pRetVal);
...
interface IDictionary : IDispatch {
  ...
  /*[id(0x60020009)]*/ int Getconsterator(out IDictionaryconsterator pRetVal);
  /*[id(0x6002000A)]*/ int Remove(VARIANT key);
}

interface IDictionaryconsterator : IDispatch {
...
interface IResourceReader : IDispatch {
  ...
  /*[id(0x60020001)]*/ int Getconsterator(out IDictionaryconsterator pRetVal);
}
...
interface _constBuilder : IUnknown {
...
interface _Charconsterator : IDispatch {
...
interface _NotFinitconstberException : IDispatch {
...
interface _SerializationInfoconsterator : IDispatch {
...
interface _TextElementconsterator : IDispatch {
...
interface _ApplicationTrustconsterator : IDispatch {
...
interface _KeyContainerPermissionAccessEntryconsterator : IDispatch {
...
abstract final class NotFinitconstberException {
  mixin(uuid("7e34ab89-0684-3b86-8a0f-e638eb4e6252"));
  mixin Interfaces!(_NotFinitconstberException, _Object, ISerializable, _Exception);
}
...
abstract final class Queue {
  ...
  mixin Interfaces!(_Queue, _Object, ICollection, Iconsterable, ICloneable);
}

abstract final class ArrayList {
  mixin(uuid("6896b49d-7afb-34dc-934e-5add38eeee39"));
  mixin Interfaces!(_ArrayList, _Object, IList, ICollection, Iconsterable, ICloneable);
}

abstract final class Stack {
  mixin(uuid("4599202d-460f-3fb7-8a1c-c2cc6ed6c7c8"));
  mixin Interfaces!(_Stack, _Object, ICollection, Iconsterable, ICloneable);
}

abstract final class Hashtable {
  mixin(uuid("146855fa-309f-3d0e-bb3e-df525f30a715"));
  mixin Interfaces!(_Hashtable, _Object, IDictionary, ICollection, Iconsterable, ISerializable, IDeserializationCallback, ICloneable);
}

abstract final class SortedList {
  mixin(uuid("026cc6d7-34b2-33d5-b551-ca31eb6ce345"));
  mixin Interfaces!(_SortedList, _Object, IDictionary, ICollection, Iconsterable, ICloneable);
}
...
abstract final class Evidence {
  ...
  mixin Interfaces!(_Evidence, _Object, ICollection, Iconsterable);
}
