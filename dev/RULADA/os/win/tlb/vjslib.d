...
struct OUTLINETEXTMETRICHelper {
  ...
  byte otmFiller2;
  byte otmFiller3;
  byte otmPanosconstber_bFamilyType;
  byte otmPanosconstber_bSerifStyle;
  byte otmPanosconstber_bWeight;
  byte otmPanosconstber_bProportion;
  byte otmPanosconstber_bContrast;
  byte otmPanosconstber_bStrokeVariation;
  byte otmPanosconstber_bArmStyle;
  byte otmPanosconstber_bLetterform;
  byte otmPanosconstber_bMidline;
  byte otmPanosconstber_bXHeight;
  byte otmFiller4;
  byte otmFiller5;
  int otmfsSelection;
  int otmfsType;
...
interface consteration : IDispatch {
...
interface AppletContext : IDispatch {
  ...
  /*[id(0x60020001)]*/ int getApplets(out consteration pRetVal);
...
interface Acl : IDispatch {
  ...
  /*[id(0x60020002)]*/ int entries(out consteration pRetVal);
  /*[id(0x60020003)]*/ int getName(out wchar* pRetVal);
  /*[id(0x60020004)]*/ int getPermissions(Principal user, out consteration pRetVal);
...
interface AclEntry : IDispatch {
  ...
  /*[id(0x60020005)]*/ int permissions(out consteration pRetVal);
...
interface Group : IDispatch {
  ...
  /*[id(0x60020002)]*/ int members(out consteration pRetVal);
...
interface _RegKeyconstValue : IDispatch {
  mixin(uuid("1b86c209-06fa-33c1-866f-e278bebf07c1"));
}

interface _RegKeyconstValueByteArray : IDispatch {
  mixin(uuid("6c22fe02-fd33-3f7d-9ab8-81de7491ccca"));
}

interface _RegKeyconstValueInt : IDispatch {
  mixin(uuid("10957f95-0b99-3e5c-b014-d4e19984cbb7"));
}

interface _RegKeyconstValueString : IDispatch {
...
interface _RegKeyValueconsterator : IDispatch {
...
interface _LinconstberInputStream : IDispatch {
  mixin(uuid("7b8b55e1-8c2a-36a3-9654-e66ad17c233b"));
}

interface _LinconstberReader : IDispatch {
...
interface _CorArrayWrapper : IDispatch {
...
interface _ZipEntryconst : IDispatch {
...
interface _VerifierFix : IDispatch {
...
interface _Hashtableconsterator : IDispatch {
...
interface _Vectorconsterator : IDispatch {
...
interface _Collectionconsteration : IDispatch {
...
interface _CALINFO_constPROC : IDispatch {
...
interface _CODEPAGE_constPROC : IDispatch {
...
interface _DATEFMT_constPROC : IDispatch {
...
interface _DESKTOPconstPROC : IDispatch {
...
interface _FONTconstPROC : IDispatch {
...
interface _GOBJconstPROCBRUSH : IDispatch {
  mixin(uuid("4de23a5b-9a91-3c0c-b2cd-1a0367326eba"));
}

interface _GOBJconstPROCPEN : IDispatch {
...
interface _ICMconstPROC : IDispatch {
...
interface _LOCALE_constPROC : IDispatch {
...
interface _PROPconstPROC : IDispatch {
  mixin(uuid("b0ac69c7-cdd5-3cb7-b4ff-e73362ad51d7"));
}

interface _PROPconstPROCEX : IDispatch {
...
interface _TIMEFMT_constPROC : IDispatch {
...
interface _WINSTAconstPROC : IDispatch {
...
interface _WNDconstPROC : IDispatch {
...
interface _CIconstVariantWrapper_NCW : IDispatch {
  ...
  /*[id(0x60020007)]*/ int Clone(out IconstVARIANT pRetVal);
...
abstract final class Queue {
  ...
  mixin Interfaces!(_Queue, _Object, consteration, ICloneable);
}
...
abstract final class RegKeyconstValueByteArray {
  mixin(uuid("86357d52-3c3b-3f0d-9eb6-83de3aca127b"));
  mixin Interfaces!(_RegKeyconstValueByteArray, _Object);
}

abstract final class RegKeyconstValueInt {
  mixin(uuid("3ca548a1-da82-3b82-b328-ff03540f57a7"));
  mixin Interfaces!(_RegKeyconstValueInt, _Object);
}

abstract final class RegKeyconstValueString {
  mixin(uuid("84abaf0a-08b9-3373-b767-820f3b1c14cd"));
  mixin Interfaces!(_RegKeyconstValueString, _Object);
}
...
abstract final class CorArrayWrapper {
  ...
  mixin Interfaces!(_CorArrayWrapper, _Object);
}
...
abstract final class VerifierFix {
  ...
  mixin Interfaces!(_VerifierFix, _Object);
}
...
abstract final class constLOGFONT {
  mixin(uuid("0570f5c0-732a-394f-b556-647cc930d1d1"));
  mixin Interfaces!(_constLOGFONT, _Object, IJavaStruct);
}

abstract final class constLOGFONTEX {
  mixin(uuid("66ddedeb-d662-3569-a445-cee86bcce0a6"));
  mixin Interfaces!(_constLOGFONTEX, _Object, IJavaStruct);
}

abstract final class constLOGFONTEX_X {
  mixin(uuid("65b3ab17-2954-39d9-8e17-24a94115b211"));
  mixin Interfaces!(_constLOGFONTEX_X, _Object, IJavaStruct);
}
