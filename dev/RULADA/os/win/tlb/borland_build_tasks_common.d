...
interface ICallBackObject : IDispatch {
  ...
  /*[id(0x60020000)]*/ int LogError(wchar* subcategory, wchar* errorCode, wchar* helpKeyword, wchar* file, int linconstber, int columnNumber, wchar* message);
  /*[id(0x60020001)]*/ int LogWarning(wchar* subcategory, wchar* warningCode, wchar* helpKeyword, wchar* file, int linconstber, int columnNumber, wchar* message);
  /*[id(0x60020002)]*/ int LogHint(wchar* subcategory, wchar* hintCode, wchar* helpKeyword, wchar* file, int linconstber, int columnNumber, wchar* message);
...
interface IBDSHostObject : IDispatch {
  ...
  /*[id(0x6002000C)]*/ int SetLogger(void* logger);
