...
alias MidpointRounding ОкруглениеДоСреднего;
...
alias DebuggerBrowsableState ВидимоеСостояниеОтладчика;
...
enum SymAddressKind {
  ...
  СмещениеПЯ = 0x00000001,
  ИсконныйОВА = 0x00000002,
...
alias AssemblyNameFlags ФлагиИмениСборки;
...
alias BindingFlags ФлагиПодвязки;
enum BindingFlags {
...
alias CallingConventions КонвенцииВызова;
...
alias FieldAttributes АтрибутыПоля;
...
alias ResourceLocation РазмещениеРесурса;
...
alias MethodAttributes АтрибутыМетода;
