...
interface IDataSource : IDispatch {
  ...
  // Not implemented. Reserved for future use.
  /*[id(0x000000FD)]*/ int SaveTo(wchar* SourceURL, IDispatch ActiveConnection, ConnectModeconst Mode, RecordCreateOptionsconst CreateOptions, RecordOpenOptionsconst Options, wchar* UserName, wchar* Password);
  // Not implemented. Reserved for future use.
  /*[id(0x000000FE)]*/ int Open(wchar* SourceURL, IDispatch ActiveConnection, ConnectModeconst Mode, RecordCreateOptionsconst CreateOptions, RecordOpenOptionsconst Options, wchar* UserName, wchar* Password);
  // Saves data into the currently bound object.
  /*[id(0x000000FF)]*/ int Save();
  // Not implemented. Reserved for future use.
  /*[id(0x00000100)]*/ int SaveToContainer(wchar* ContainerURL, IDispatch ActiveConnection, ConnectModeconst Mode, RecordCreateOptionsconst CreateOptions, RecordOpenOptionsconst Options, wchar* UserName, wchar* Password);
}
