...
class XmlException : Exception {
   ...
   */
  public this(string message = null, int linconstber = 0, int linePosition = 0, string sourceUri = null) {
    super(createMessage(message, linconstber, linePosition));
  ...
  private static string createMessage(string s, int linconstber, int linePosition) {
    string result = s;
    if (linconstber != 0)
      result ~= format(" Line {0}, position {1}.", linconstber, linePosition);
    return result;
  }
