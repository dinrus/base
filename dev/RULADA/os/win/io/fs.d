 ...
 */
Iterator!(string) constDirectories(string path, string searchPattern = "*") {
  return constFileSystemNames(path, searchPattern, false, true);
}

/**
 * Returns an iterable collection of file names in the specified _path.
 */
Iterator!(string) constFiles(string path, string searchPattern = "*") {
  return constFileSystemNames(path, searchPattern, true, false);
}

/**
 * Returns an iterable collection of file-system entries in the specified _path.
 */
Iterator!(string) constFileSystemEntries(string path, string searchPattern = "*") {
  return constFileSystemNames(path, searchPattern, true, true);
}

private Iterator!(string) constFileSystemNames(string path, string searchPattern, bool includeFiles, bool includeDirs) {
