...
struct Token
{
	...
	[
		...
		Local: "местпер",
		Module: "модуль",
		Namespace: "зоним", //зона действия имён
		Null: "пусто",
		Return: "верни",
		Scope: "масш",
		Super: "супер",
		...
		Ident: "Опознаватель",
		CharLiteral: "Символьник",
		StringLiteral: "Строчник",
		IntLiteral: "Цельник",
		FloatLiteral: "Двойник",
		EOF: "<EOF>"
	];
...
// ================================================================================================================================================
	...
	{
		return ((mCharacter >= 'a') && (mCharacter <= 'z')) || ((mCharacter >= 'A') && (mCharacter <= 'Z')||(mCharacter >= 'а') && (mCharacter <= 'я')) || ((mCharacter >= 'А') && (mCharacter <= 'Я'));
	}
