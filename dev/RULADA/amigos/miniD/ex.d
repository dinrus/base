/******************************************************************************
This module contains the "расширение" API, which is a bunch of useful
...
public void checkInstParam()(MDThread* t, word index)
{
	...
	if(!isInstance(t, index))
		paramTypeError(t, index, "экземпл");
}
...
{
	const IsIdentBeginChar = (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z') ||(c >= 'а' && c <= 'я') || (c >= 'А' && c <= 'Я') || c == '_';
}
