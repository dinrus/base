...
$(UL
	...
	$(LI $(B MDThread.Hook.TailRet) - This hook occurs immediately after "верни" hooks if the
...
word toStringImpl(MDThread* t, MDValue v, bool raw)
{
	...
	switch(v.type)
	{
		case MDValue.Type.Null:  return pushString(t, "пусто");
		case MDValue.Type.Bool:  return pushString(t, v.mBool ? "вкл" : "выкл");
