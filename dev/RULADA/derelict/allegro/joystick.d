...
цел установи_джойст(цел тип)
{
return cast(цел) install_joystick(cast(int) тип);
}

цел сохрани_дан_о_джойсте(in усим фимя)
{
return cast(цел) save_joystick_data(cast(char *) фимя);
}

цел загрузи_дан_о_джойсте(in усим фимя)
{
return cast(цел) load_joystick_data(cast(char *) фимя);
}